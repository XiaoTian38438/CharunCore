...
public interface TypeRewriteRule {
    ...
    public static TypeRewriteRule seq(TypeRewriteRule typeRewriteRule, TypeRewriteRule typeRewriteRule2) {
        ...
        return TypeRewriteRule.seq((List<TypeRewriteRule>)ImmutableList.of((Object)typeRewriteRule, (Object)typeRewriteRule2));
    }
    ...
    public static TypeRewriteRule orElse(TypeRewriteRule typeRewriteRule, TypeRewriteRule typeRewriteRule2) {
        return TypeRewriteRule.orElse(typeRewriteRule, () -> typeRewriteRule2);
    }
    ...
    public static TypeRewriteRule once(TypeRewriteRule typeRewriteRule) {
        return TypeRewriteRule.orElse(typeRewriteRule, () -> TypeRewriteRule.one(TypeRewriteRule.once(typeRewriteRule)));
    }
    ...
    implements TypeRewriteRule {
        ...
        protected <A, B> Optional<RewriteResult<A, ?>> cap1(TypeRewriteRule typeRewriteRule, RewriteResult<A, B> rewriteResult) {
            return typeRewriteRule.rewrite(rewriteResult.view().newType()).map(rewriteResult2 -> rewriteResult2.compose(rewriteResult));
        }
    ...
    public record One(TypeRewriteRule rule) implements TypeRewriteRule
    {
        @Override
        public <A> Optional<RewriteResult<A, ?>> rewrite(Type<A> type) {
    ...
    public record CheckOnce(TypeRewriteRule rule, Consumer<Type<?>> onFail) implements TypeRewriteRule
    {
        @Override
        public <A> Optional<RewriteResult<A, ?>> rewrite(Type<A> type) {
