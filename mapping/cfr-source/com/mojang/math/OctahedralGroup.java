...
public enum OctahedralGroup implements StringRepresentable
{
    ...
    private static int trace(boolean bl, boolean bl2, boolean bl3, SymmetricGroup3 symmetricGroup3) {
        ...
        return symmetricGroup3.ordinal() << 3 | n;
    }
    ...
    static {
        ...
        CAYLEY_TABLE = Util.make(() -> {
            OctahedralGroup[] octahedralGroupArray = OctahedralGroup.values();
            OctahedralGroup[][] octahedralGroupArray2 = new OctahedralGroup[octahedralGroupArray.length][octahedralGroupArray.length];
            Map<Integer, OctahedralGroup> map = Arrays.stream(octahedralGroupArray).collect(Collectors.toMap(OctahedralGroup::trace, octahedralGroup -> octahedralGroup));
            for (OctahedralGroup octahedralGroup2 : octahedralGroupArray) {
                for (OctahedralGroup octahedralGroup3 : octahedralGroupArray) {
                    SymmetricGroup3 symmetricGroup3 = octahedralGroup3.permutation.compose(octahedralGroup2.permutation);
                    boolean bl = octahedralGroup2.inverts(Direction.Axis.X) ^ octahedralGroup3.inverts(octahedralGroup2.permutation.permuteAxis(Direction.Axis.X));
                    boolean bl2 = octahedralGroup2.inverts(Direction.Axis.Y) ^ octahedralGroup3.inverts(octahedralGroup2.permutation.permuteAxis(Direction.Axis.Y));
                    boolean bl3 = octahedralGroup2.inverts(Direction.Axis.Z) ^ octahedralGroup3.inverts(octahedralGroup2.permutation.permuteAxis(Direction.Axis.Z));
                    octahedralGroupArray2[octahedralGroup2.ordinal()][octahedralGroup3.ordinal()] = map.get(OctahedralGroup.trace(bl, bl2, bl3, symmetricGroup3));
                }
            }
            return octahedralGroupArray2;
        });
