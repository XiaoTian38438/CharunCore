...
implements Comparable<MobEffectInstance> {
    ...
    public static final Codec<MobEffectInstance> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)MobEffect.CODEC.fieldOf("id")).forGetter(MobEffectInstance::getEffect), Details.MAP_CODEC.forGetter(MobEffectInstance::asDetails)).apply((Applicative<MobEffectInstance, ?>)instance, MobEffectInstance::new));
    ...
    record Details(int amplifier, int duration, boolean ambient, boolean showParticles, boolean showIcon, Optional<Details> hiddenEffect) {
        public static final MapCodec<Details> MAP_CODEC = MapCodec.recursive("MobEffectInstance.Details", codec -> RecordCodecBuilder.mapCodec(instance -> instance.group(ExtraCodecs.UNSIGNED_BYTE.optionalFieldOf("amplifier", 0).forGetter(Details::amplifier), Codec.INT.optionalFieldOf("duration", 0).forGetter(Details::duration), Codec.BOOL.optionalFieldOf("ambient", false).forGetter(Details::ambient), Codec.BOOL.optionalFieldOf("show_particles", true).forGetter(Details::showParticles), Codec.BOOL.optionalFieldOf("show_icon").forGetter(details -> Optional.of(details.showIcon())), codec.optionalFieldOf("hidden_effect").forGetter(Details::hiddenEffect)).apply((Applicative<Details, ?>)instance, Details::create)));
