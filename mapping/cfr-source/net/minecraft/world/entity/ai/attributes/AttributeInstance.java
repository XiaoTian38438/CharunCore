...
public class AttributeInstance {
    ...
    extends Record {
        ...
        public static final Codec<Packed> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BuiltInRegistries.ATTRIBUTE.holderByNameCodec().fieldOf("id")).forGetter(Packed::attribute), ((MapCodec)Codec.DOUBLE.fieldOf("base")).orElse(0.0).forGetter(Packed::baseValue), AttributeModifier.CODEC.listOf().optionalFieldOf("modifiers", List.of()).forGetter(Packed::modifiers)).apply((Applicative<Packed, ?>)instance, Packed::new));
