...
extends Goal {
    ...
    public AvoidEntityGoal(PathfinderMob pathfinderMob, Class<T> clazz, float f, double d, double d2) {
        this(pathfinderMob, clazz, livingEntity -> true, f, d, d2, EntitySelector.NO_CREATIVE_OR_SPECTATOR);
    }

    public AvoidEntityGoal(PathfinderMob pathfinderMob, Class<T> clazz, Predicate<LivingEntity> predicate, float f, double d, double d2, Predicate<? super LivingEntity> predicate2) {
    ...
    public AvoidEntityGoal(PathfinderMob pathfinderMob, Class<T> clazz, float f, double d, double d2, Predicate<? super LivingEntity> predicate) {
