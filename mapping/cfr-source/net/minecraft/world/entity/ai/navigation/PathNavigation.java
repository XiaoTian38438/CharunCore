...
public abstract class PathNavigation {
    ...
    public final @Nullable Path createPath(double d, double d2, double d3, int n) {
        return this.createPath(BlockPos.containing(d, d2, d3), n);
    }

    public @Nullable Path createPath(Stream<BlockPos> stream, int n) {
        return this.createPath(stream.collect(Collectors.toSet()), 8, false, n);
    }

    public @Nullable Path createPath(Set<BlockPos> set, int n) {
        return this.createPath(set, 8, false, n);
    }

    public @Nullable Path createPath(BlockPos blockPos, int n) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)blockPos), 8, false, n);
    }

    public @Nullable Path createPath(BlockPos blockPos, int n, int n2) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)blockPos), 8, false, n, n2);
    }

    public @Nullable Path createPath(Entity entity, int n) {
        return this.createPath((Set<BlockPos>)ImmutableSet.of((Object)entity.blockPosition()), 16, true, n);
    }

    protected @Nullable Path createPath(Set<BlockPos> set, int n, boolean bl, int n2) {
        return this.createPath(set, n, bl, n2, this.getMaxPathLength());
    }

    protected @Nullable Path createPath(Set<BlockPos> set, int n, boolean bl, int n2, float f) {
        if (set.isEmpty()) {
            return null;
        }
