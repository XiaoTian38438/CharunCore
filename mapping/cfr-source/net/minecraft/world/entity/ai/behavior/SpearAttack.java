...
extends Behavior<PathfinderMob> {
    ...
    public SpearAttack(double d, double d2, float f, float f2) {
    ...
    protected void tick(ServerLevel serverLevel, PathfinderMob pathfinderMob, long l) {
        ...
        if (vec3 != null) {
            ...
            if (d < (double)this.targetInRangeRadiusSq || pathfinderMob.getNavigation().isDone()) {
                ...
                Vec3 vec32 = LandRandomPos.getPosAway(pathfinderMob, (double)(6 + n) - d2, (double)(7 + n) - d2, 7, livingEntity.position());
