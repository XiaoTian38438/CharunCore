...
public class PoiRecord {
    ...
    public record Packed(BlockPos pos, Holder<PoiType> poiType, int freeTickets) {
        public static final Codec<Packed> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockPos.CODEC.fieldOf("pos")).forGetter(Packed::pos), ((MapCodec)RegistryFixedCodec.create(Registries.POINT_OF_INTEREST_TYPE).fieldOf("type")).forGetter(Packed::poiType), ((MapCodec)Codec.INT.fieldOf("free_tickets")).orElse(0).forGetter(Packed::freeTickets)).apply((Applicative<Packed, ?>)instance, Packed::new));
