...
public class PoiSection {
    ...
    public record Packed(boolean isValid, List<PoiRecord.Packed> records) {
        public static final Codec<Packed> CODEC = RecordCodecBuilder.create(instance -> instance.group(Codec.BOOL.lenientOptionalFieldOf("Valid", false).forGetter(Packed::isValid), ((MapCodec)PoiRecord.Packed.CODEC.listOf().fieldOf("Records")).forGetter(Packed::records)).apply((Applicative<Packed, ?>)instance, Packed::new));
