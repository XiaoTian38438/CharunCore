...
public class InterpolationHandler {
    ...
    public void interpolateTo(Vec3 vec3, float f, float f2) {
        ...
        if (this.hasActiveInterpolation() && Objects.equals(Float.valueOf(this.yRot()), Float.valueOf(f)) && Objects.equals(Float.valueOf(this.xRot()), Float.valueOf(f2)) && Objects.equals(this.position(), vec3)) {
            return;
        }
