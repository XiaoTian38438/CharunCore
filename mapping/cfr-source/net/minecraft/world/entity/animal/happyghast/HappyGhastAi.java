...
public class HappyGhastAi {
    ...
    private static void initIdleActivity(Brain<HappyGhast> brain) {
        brain.addActivity(Activity.IDLE, (ImmutableList<Pair<Integer, BehaviorControl<HappyGhast>>>)ImmutableList.of(Pair.of(1, new FollowTemptation(livingEntity -> Float.valueOf(1.25f), livingEntity -> 3.0, true)), Pair.of(2, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, livingEntity -> Float.valueOf(1.1f), MemoryModuleType.NEAREST_VISIBLE_PLAYER, true)), Pair.of(3, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, livingEntity -> Float.valueOf(1.1f), MemoryModuleType.NEAREST_VISIBLE_ADULT, true)), Pair.of(4, new RunOne(ImmutableList.of(Pair.of(RandomStroll.fly(1.0f), 1), Pair.of(SetWalkTargetFromLookTarget.create(1.0f, 3), 1))))));
    }

    private static void initPanicActivity(Brain<HappyGhast> brain) {
        brain.addActivityWithConditions(Activity.PANIC, (ImmutableList<Pair<Integer, BehaviorControl<HappyGhast>>>)ImmutableList.of(), Set.of(Pair.of(MemoryModuleType.IS_PANICKING, MemoryStatus.VALUE_PRESENT)));
    }
