...
{
    public static final Codec<PigVariant> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(PigVariant::modelAndTexture), ((MapCodec)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions")).forGetter(PigVariant::spawnConditions)).apply((Applicative<PigVariant, ?>)instance, PigVariant::new));
    public static final Codec<PigVariant> NETWORK_CODEC = RecordCodecBuilder.create(instance -> instance.group(ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(PigVariant::modelAndTexture)).apply((Applicative<PigVariant, ?>)instance, PigVariant::new));
