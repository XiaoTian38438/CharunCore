...
{
    public static final Codec<WolfVariant> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)AssetInfo.CODEC.fieldOf("assets")).forGetter(WolfVariant::assetInfo), ((MapCodec)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions")).forGetter(WolfVariant::spawnConditions)).apply((Applicative<WolfVariant, ?>)instance, WolfVariant::new));
    public static final Codec<WolfVariant> NETWORK_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)AssetInfo.CODEC.fieldOf("assets")).forGetter(WolfVariant::assetInfo)).apply((Applicative<WolfVariant, ?>)instance, WolfVariant::new));
