...
public class SnifferAi {
    ...
    private static void initIdleActivity(Brain<Sniffer> brain) {
        ...
        }), Pair.of(1, new FollowTemptation(livingEntity -> Float.valueOf(1.25f), livingEntity -> livingEntity.isBaby() ? 2.5 : 3.5){
