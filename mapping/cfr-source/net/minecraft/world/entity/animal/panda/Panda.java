...
extends Animal {
    ...
    private void afterSneeze() {
        ...
        object = this.level();
        if (object instanceof ServerLevel && ((ServerLevel)(object2 = (ServerLevel)object)).getGameRules().get(GameRules.MOB_DROPS).booleanValue()) {
    ...
    extends AvoidEntityGoal<T> {
        ...
        public PandaAvoidGoal(Panda panda, Class<T> clazz, float f, double d, double d2) {
            super(panda, clazz, f, d, d2, EntitySelector.NO_SPECTATORS);
            this.panda = panda;
        }
