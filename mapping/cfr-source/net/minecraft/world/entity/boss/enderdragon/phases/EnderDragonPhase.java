...
public class EnderDragonPhase<T extends DragonPhaseInstance> {
    ...
    private EnderDragonPhase(int n, Class<? extends DragonPhaseInstance> clazz, String string) {
        this.id = n;
    ...
    private static <T extends DragonPhaseInstance> EnderDragonPhase<T> create(Class<T> clazz, String string) {
        EnderDragonPhase<T> enderDragonPhase = new EnderDragonPhase<T>(phases.length, clazz, string);
