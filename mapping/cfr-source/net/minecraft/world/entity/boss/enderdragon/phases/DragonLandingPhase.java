...
extends AbstractDragonPhaseInstance {
    ...
    public void doClientTick() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            this.dragon.level().addParticle(PowerParticleOption.create(ParticleTypes.DRAGON_BREATH, 1.0f), d4, d5, d6, -vec3.x * (double)0.08f + vec32.x, -vec3.y * (double)0.3f + vec32.y, -vec3.z * (double)0.08f + vec32.z);
