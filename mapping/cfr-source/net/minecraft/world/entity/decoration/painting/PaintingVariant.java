...
public record PaintingVariant(int width, int height, Identifier assetId, Optional<Component> title, Optional<Component> author) {
    public static final Codec<PaintingVariant> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)ExtraCodecs.intRange(1, 16).fieldOf("width")).forGetter(PaintingVariant::width), ((MapCodec)ExtraCodecs.intRange(1, 16).fieldOf("height")).forGetter(PaintingVariant::height), ((MapCodec)Identifier.CODEC.fieldOf("asset_id")).forGetter(PaintingVariant::assetId), ComponentSerialization.CODEC.optionalFieldOf("title").forGetter(PaintingVariant::title), ComponentSerialization.CODEC.optionalFieldOf("author").forGetter(PaintingVariant::author)).apply((Applicative<PaintingVariant, ?>)instance, PaintingVariant::new));
