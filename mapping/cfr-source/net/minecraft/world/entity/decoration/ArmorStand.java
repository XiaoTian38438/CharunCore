...
extends LivingEntity {
    ...
    public record ArmorStandPose(Rotations head, Rotations body, Rotations leftArm, Rotations rightArm, Rotations leftLeg, Rotations rightLeg) {
        ...
        public static final Codec<ArmorStandPose> CODEC = RecordCodecBuilder.create(instance -> instance.group(Rotations.CODEC.optionalFieldOf("Head", DEFAULT_HEAD_POSE).forGetter(ArmorStandPose::head), Rotations.CODEC.optionalFieldOf("Body", DEFAULT_BODY_POSE).forGetter(ArmorStandPose::body), Rotations.CODEC.optionalFieldOf("LeftArm", DEFAULT_LEFT_ARM_POSE).forGetter(ArmorStandPose::leftArm), Rotations.CODEC.optionalFieldOf("RightArm", DEFAULT_RIGHT_ARM_POSE).forGetter(ArmorStandPose::rightArm), Rotations.CODEC.optionalFieldOf("LeftLeg", DEFAULT_LEFT_LEG_POSE).forGetter(ArmorStandPose::leftLeg), Rotations.CODEC.optionalFieldOf("RightLeg", DEFAULT_RIGHT_LEG_POSE).forGetter(ArmorStandPose::rightLeg)).apply((Applicative<ArmorStandPose, ?>)instance, ArmorStandPose::new));
    }
}
