...
public class ObjectiveCriteria {
    ...
    public static Optional<ObjectiveCriteria> byName(String string) {
        ...
        return BuiltInRegistries.STAT_TYPE.getOptional(Identifier.bySeparator(string.substring(0, n), '.')).flatMap(statType -> ObjectiveCriteria.getStat(statType, Identifier.bySeparator(string.substring(n + 1), '.')));
    }
