...
implements ReadOnlyScoreInfo {
    ...
    extends Record {
        ...
        public static final MapCodec<Packed> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.INT.optionalFieldOf("Score", 0).forGetter(Packed::value), Codec.BOOL.optionalFieldOf("Locked", false).forGetter(Packed::locked), ComponentSerialization.CODEC.optionalFieldOf("display").forGetter(Packed::display), NumberFormatTypes.CODEC.optionalFieldOf("format").forGetter(Packed::numberFormat)).apply((Applicative<Packed, ?>)instance, Packed::new));

        public Packed(int n, boolean bl, Optional<Component> optional, Optional<NumberFormat> optional2) {
            this.value = n;
            this.locked = bl;
