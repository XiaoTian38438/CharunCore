...
public class Scoreboard {
    ...
    extends Record {
        ...
        public static final Codec<PackedScore> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.STRING.fieldOf("Name")).forGetter(PackedScore::owner), ((MapCodec)Codec.STRING.fieldOf("Objective")).forGetter(PackedScore::objective), Score.Packed.MAP_CODEC.forGetter(PackedScore::score)).apply((Applicative<PackedScore, ?>)instance, PackedScore::new));
