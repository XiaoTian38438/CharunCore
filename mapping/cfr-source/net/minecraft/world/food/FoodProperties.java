...
{
    public static final Codec<FoodProperties> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)ExtraCodecs.NON_NEGATIVE_INT.fieldOf("nutrition")).forGetter(FoodProperties::nutrition), ((MapCodec)Codec.FLOAT.fieldOf("saturation")).forGetter(FoodProperties::saturation), Codec.BOOL.optionalFieldOf("can_always_eat", false).forGetter(FoodProperties::canAlwaysEat)).apply((Applicative<FoodProperties, ?>)instance, FoodProperties::new));
