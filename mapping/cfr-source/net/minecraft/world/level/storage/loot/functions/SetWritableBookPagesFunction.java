...
extends LootItemConditionalFunction {
    public static final MapCodec<SetWritableBookPagesFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetWritableBookPagesFunction.commonFields(instance).and(instance.group(((MapCodec)WritableBookContent.PAGES_CODEC.fieldOf("pages")).forGetter(setWritableBookPagesFunction -> setWritableBookPagesFunction.pages), ListOperation.codec(100).forGetter(setWritableBookPagesFunction -> setWritableBookPagesFunction.pageOperation))).apply((Applicative<SetWritableBookPagesFunction, ?>)instance, SetWritableBookPagesFunction::new));
