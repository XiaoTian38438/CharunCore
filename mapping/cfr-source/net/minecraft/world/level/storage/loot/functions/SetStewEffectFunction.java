...
extends LootItemConditionalFunction {
    private static final Codec<List<EffectEntry>> EFFECTS_LIST = EffectEntry.CODEC.listOf().validate((A list) -> {
    ...
    public static final MapCodec<SetStewEffectFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetStewEffectFunction.commonFields(instance).and(EFFECTS_LIST.optionalFieldOf("effects", List.of()).forGetter(setStewEffectFunction -> setStewEffectFunction.effects)).apply((Applicative<SetStewEffectFunction, ?>)instance, SetStewEffectFunction::new));
    ...
    record EffectEntry(Holder<MobEffect> effect, NumberProvider duration) {
        public static final Codec<EffectEntry> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)MobEffect.CODEC.fieldOf("type")).forGetter(EffectEntry::effect), ((MapCodec)NumberProviders.CODEC.fieldOf("duration")).forGetter(EffectEntry::duration)).apply((Applicative<EffectEntry, ?>)instance, EffectEntry::new));
    }
