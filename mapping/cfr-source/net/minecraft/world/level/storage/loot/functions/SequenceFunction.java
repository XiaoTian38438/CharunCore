...
implements LootItemFunction {
    public static final MapCodec<SequenceFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)LootItemFunctions.TYPED_CODEC.listOf().fieldOf("functions")).forGetter(sequenceFunction -> sequenceFunction.functions)).apply((Applicative<SequenceFunction, ?>)instance, SequenceFunction::new));
