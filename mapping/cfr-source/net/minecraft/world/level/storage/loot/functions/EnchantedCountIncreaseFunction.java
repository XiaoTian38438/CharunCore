...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<EnchantedCountIncreaseFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> EnchantedCountIncreaseFunction.commonFields(instance).and(instance.group(((MapCodec)Enchantment.CODEC.fieldOf("enchantment")).forGetter(enchantedCountIncreaseFunction -> enchantedCountIncreaseFunction.enchantment), ((MapCodec)NumberProviders.CODEC.fieldOf("count")).forGetter(enchantedCountIncreaseFunction -> enchantedCountIncreaseFunction.value), Codec.INT.optionalFieldOf("limit", 0).forGetter(enchantedCountIncreaseFunction -> enchantedCountIncreaseFunction.limit))).apply((Applicative<EnchantedCountIncreaseFunction, ?>)instance, EnchantedCountIncreaseFunction::new));
