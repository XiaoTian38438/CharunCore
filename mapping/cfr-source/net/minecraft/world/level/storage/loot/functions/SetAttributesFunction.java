...
extends LootItemConditionalFunction {
    public static final MapCodec<SetAttributesFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetAttributesFunction.commonFields(instance).and(instance.group(((MapCodec)Modifier.CODEC.listOf().fieldOf("modifiers")).forGetter(setAttributesFunction -> setAttributesFunction.modifiers), Codec.BOOL.optionalFieldOf("replace", true).forGetter(setAttributesFunction -> setAttributesFunction.replace))).apply((Applicative<SetAttributesFunction, ?>)instance, SetAttributesFunction::new));
    ...
    extends Record {
        ...
        public static final Codec<Modifier> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Identifier.CODEC.fieldOf("id")).forGetter(Modifier::id), ((MapCodec)Attribute.CODEC.fieldOf("attribute")).forGetter(Modifier::attribute), ((MapCodec)AttributeModifier.Operation.CODEC.fieldOf("operation")).forGetter(Modifier::operation), ((MapCodec)NumberProviders.CODEC.fieldOf("amount")).forGetter(Modifier::amount), ((MapCodec)SLOTS_CODEC.fieldOf("slot")).forGetter(Modifier::slots)).apply((Applicative<Modifier, ?>)instance, Modifier::new));
