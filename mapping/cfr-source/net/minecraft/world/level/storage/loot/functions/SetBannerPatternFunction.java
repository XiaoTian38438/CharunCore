...
extends LootItemConditionalFunction {
    public static final MapCodec<SetBannerPatternFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetBannerPatternFunction.commonFields(instance).and(instance.group(((MapCodec)BannerPatternLayers.CODEC.fieldOf("patterns")).forGetter(setBannerPatternFunction -> setBannerPatternFunction.patterns), ((MapCodec)Codec.BOOL.fieldOf("append")).forGetter(setBannerPatternFunction -> setBannerPatternFunction.append))).apply((Applicative<SetBannerPatternFunction, ?>)instance, SetBannerPatternFunction::new));
