...
extends LootItemConditionalFunction {
    public static final MapCodec<FillPlayerHead> CODEC = RecordCodecBuilder.mapCodec(instance -> FillPlayerHead.commonFields(instance).and(((MapCodec)LootContext.EntityTarget.CODEC.fieldOf("entity")).forGetter(fillPlayerHead -> fillPlayerHead.entityTarget)).apply((Applicative<FillPlayerHead, ?>)instance, FillPlayerHead::new));
