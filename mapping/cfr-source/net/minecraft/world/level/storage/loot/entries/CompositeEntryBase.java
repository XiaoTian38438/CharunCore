...
extends LootPoolEntryContainer {
    ...
    public static <T extends CompositeEntryBase> MapCodec<T> createCodec(CompositeEntryConstructor<T> compositeEntryConstructor) {
        return RecordCodecBuilder.mapCodec(instance -> instance.group(LootPoolEntries.CODEC.listOf().optionalFieldOf("children", List.of()).forGetter(compositeEntryBase -> compositeEntryBase.children)).and(CompositeEntryBase.commonFields(instance).t1()).apply(instance, compositeEntryConstructor::create));
    }
