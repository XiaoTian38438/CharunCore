...
extends LootItemConditionalFunction {
    public static final MapCodec<ToggleTooltips> CODEC = RecordCodecBuilder.mapCodec(instance -> ToggleTooltips.commonFields(instance).and(((MapCodec)Codec.unboundedMap(DataComponentType.CODEC, Codec.BOOL).fieldOf("toggles")).forGetter(toggleTooltips -> toggleTooltips.values)).apply((Applicative<ToggleTooltips, ?>)instance, ToggleTooltips::new));
