...
{
    public static final MapCodec<ContextScoreboardNameProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)LootContext.EntityTarget.CODEC.fieldOf("target")).forGetter(ContextScoreboardNameProvider::target)).apply((Applicative<ContextScoreboardNameProvider, ?>)instance, ContextScoreboardNameProvider::new));
