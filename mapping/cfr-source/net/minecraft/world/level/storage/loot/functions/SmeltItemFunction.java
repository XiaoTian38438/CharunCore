...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<SmeltItemFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SmeltItemFunction.commonFields(instance).apply(instance, SmeltItemFunction::new));
