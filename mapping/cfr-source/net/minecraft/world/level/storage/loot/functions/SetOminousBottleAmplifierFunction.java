...
extends LootItemConditionalFunction {
    static final MapCodec<SetOminousBottleAmplifierFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetOminousBottleAmplifierFunction.commonFields(instance).and(((MapCodec)NumberProviders.CODEC.fieldOf("amplifier")).forGetter(setOminousBottleAmplifierFunction -> setOminousBottleAmplifierFunction.amplifierGenerator)).apply((Applicative<SetOminousBottleAmplifierFunction, ?>)instance, SetOminousBottleAmplifierFunction::new));
