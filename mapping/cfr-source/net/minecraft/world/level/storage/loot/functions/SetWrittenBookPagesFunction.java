...
extends LootItemConditionalFunction {
    public static final MapCodec<SetWrittenBookPagesFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetWrittenBookPagesFunction.commonFields(instance).and(instance.group(((MapCodec)WrittenBookContent.PAGES_CODEC.fieldOf("pages")).forGetter(setWrittenBookPagesFunction -> setWrittenBookPagesFunction.pages), ListOperation.UNLIMITED_CODEC.forGetter(setWrittenBookPagesFunction -> setWrittenBookPagesFunction.pageOperation))).apply((Applicative<SetWrittenBookPagesFunction, ?>)instance, SetWrittenBookPagesFunction::new));
