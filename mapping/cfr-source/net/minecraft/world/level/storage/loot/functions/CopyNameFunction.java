...
extends LootItemConditionalFunction {
    public static final MapCodec<CopyNameFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> CopyNameFunction.commonFields(instance).and(((MapCodec)LootContextArg.ENTITY_OR_BLOCK.fieldOf("source")).forGetter(copyNameFunction -> copyNameFunction.source)).apply((Applicative<CopyNameFunction, ?>)instance, CopyNameFunction::new));
