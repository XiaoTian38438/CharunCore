...
extends LootItemConditionalFunction {
    public static final MapCodec<SetItemCountFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetItemCountFunction.commonFields(instance).and(instance.group(((MapCodec)NumberProviders.CODEC.fieldOf("count")).forGetter(setItemCountFunction -> setItemCountFunction.value), ((MapCodec)Codec.BOOL.fieldOf("add")).orElse(false).forGetter(setItemCountFunction -> setItemCountFunction.add))).apply((Applicative<SetItemCountFunction, ?>)instance, SetItemCountFunction::new));
