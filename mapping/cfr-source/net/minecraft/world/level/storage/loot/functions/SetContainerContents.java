...
extends LootItemConditionalFunction {
    public static final MapCodec<SetContainerContents> CODEC = RecordCodecBuilder.mapCodec(instance -> SetContainerContents.commonFields(instance).and(instance.group(((MapCodec)ContainerComponentManipulators.CODEC.fieldOf("component")).forGetter(setContainerContents -> setContainerContents.component), ((MapCodec)LootPoolEntries.CODEC.listOf().fieldOf("entries")).forGetter(setContainerContents -> setContainerContents.entries))).apply((Applicative<SetContainerContents, ?>)instance, SetContainerContents::new));
