...
implements NbtProvider {
    ...
    public static final MapCodec<ContextNbtProvider> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)GETTER_CODEC.fieldOf("target")).forGetter(contextNbtProvider -> contextNbtProvider.source)).apply((Applicative<ContextNbtProvider, ?>)instance, ContextNbtProvider::new));
