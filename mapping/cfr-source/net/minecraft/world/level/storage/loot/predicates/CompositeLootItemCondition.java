...
implements LootItemCondition {
    ...
    protected static <T extends CompositeLootItemCondition> MapCodec<T> createCodec(Function<List<LootItemCondition>, T> function) {
        return RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)LootItemCondition.DIRECT_CODEC.listOf().fieldOf("terms")).forGetter(compositeLootItemCondition -> compositeLootItemCondition.terms)).apply((Applicative<CompositeLootItemCondition, ?>)instance, function));
    }
