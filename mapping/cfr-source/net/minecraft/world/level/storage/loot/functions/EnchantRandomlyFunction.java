...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<EnchantRandomlyFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> EnchantRandomlyFunction.commonFields(instance).and(instance.group(RegistryCodecs.homogeneousList(Registries.ENCHANTMENT).optionalFieldOf("options").forGetter(enchantRandomlyFunction -> enchantRandomlyFunction.options), Codec.BOOL.optionalFieldOf("only_compatible", true).forGetter(enchantRandomlyFunction -> enchantRandomlyFunction.onlyCompatible))).apply((Applicative<EnchantRandomlyFunction, ?>)instance, EnchantRandomlyFunction::new));
