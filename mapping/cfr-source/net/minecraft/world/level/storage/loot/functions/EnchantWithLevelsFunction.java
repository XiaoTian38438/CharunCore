...
extends LootItemConditionalFunction {
    public static final MapCodec<EnchantWithLevelsFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> EnchantWithLevelsFunction.commonFields(instance).and(instance.group(((MapCodec)NumberProviders.CODEC.fieldOf("levels")).forGetter(enchantWithLevelsFunction -> enchantWithLevelsFunction.levels), RegistryCodecs.homogeneousList(Registries.ENCHANTMENT).optionalFieldOf("options").forGetter(enchantWithLevelsFunction -> enchantWithLevelsFunction.options))).apply((Applicative<EnchantWithLevelsFunction, ?>)instance, EnchantWithLevelsFunction::new));
