...
{
    public static final MapCodec<InvertedLootItemCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)LootItemCondition.DIRECT_CODEC.fieldOf("term")).forGetter(InvertedLootItemCondition::term)).apply((Applicative<InvertedLootItemCondition, ?>)instance, InvertedLootItemCondition::new));
