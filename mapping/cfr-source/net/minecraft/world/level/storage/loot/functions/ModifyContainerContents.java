...
extends LootItemConditionalFunction {
    public static final MapCodec<ModifyContainerContents> CODEC = RecordCodecBuilder.mapCodec(instance -> ModifyContainerContents.commonFields(instance).and(instance.group(((MapCodec)ContainerComponentManipulators.CODEC.fieldOf("component")).forGetter(modifyContainerContents -> modifyContainerContents.component), ((MapCodec)LootItemFunctions.ROOT_CODEC.fieldOf("modifier")).forGetter(modifyContainerContents -> modifyContainerContents.modifier))).apply((Applicative<ModifyContainerContents, ?>)instance, ModifyContainerContents::new));
