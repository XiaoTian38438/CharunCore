...
extends LootItemConditionalFunction {
    public static final MapCodec<SetPotionFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetPotionFunction.commonFields(instance).and(((MapCodec)Potion.CODEC.fieldOf("id")).forGetter(setPotionFunction -> setPotionFunction.potion)).apply((Applicative<SetPotionFunction, ?>)instance, SetPotionFunction::new));
