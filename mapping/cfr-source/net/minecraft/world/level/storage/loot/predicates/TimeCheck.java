...
{
    public static final MapCodec<TimeCheck> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.LONG.optionalFieldOf("period").forGetter(TimeCheck::period), ((MapCodec)IntRange.CODEC.fieldOf("value")).forGetter(TimeCheck::value)).apply((Applicative<TimeCheck, ?>)instance, TimeCheck::new));
