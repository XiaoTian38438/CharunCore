...
{
    public static final MapCodec<LootItemEntityPropertyCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(EntityPredicate.CODEC.optionalFieldOf("predicate").forGetter(LootItemEntityPropertyCondition::predicate), ((MapCodec)LootContext.EntityTarget.CODEC.fieldOf("entity")).forGetter(LootItemEntityPropertyCondition::entityTarget)).apply((Applicative<LootItemEntityPropertyCondition, ?>)instance, LootItemEntityPropertyCondition::new));
