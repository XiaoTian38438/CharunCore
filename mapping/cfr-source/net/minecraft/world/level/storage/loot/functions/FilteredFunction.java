...
extends LootItemConditionalFunction {
    public static final MapCodec<FilteredFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> FilteredFunction.commonFields(instance).and(instance.group(((MapCodec)ItemPredicate.CODEC.fieldOf("item_filter")).forGetter(filteredFunction -> filteredFunction.filter), LootItemFunctions.ROOT_CODEC.optionalFieldOf("on_pass").forGetter(filteredFunction -> filteredFunction.onPass), LootItemFunctions.ROOT_CODEC.optionalFieldOf("on_fail").forGetter(filteredFunction -> filteredFunction.onFail))).apply((Applicative<FilteredFunction, ?>)instance, FilteredFunction::new));
