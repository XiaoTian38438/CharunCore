...
extends LootItemConditionalFunction {
    public static final MapCodec<SetEnchantmentsFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetEnchantmentsFunction.commonFields(instance).and(instance.group(Codec.unboundedMap(Enchantment.CODEC, NumberProviders.CODEC).optionalFieldOf("enchantments", Map.of()).forGetter(setEnchantmentsFunction -> setEnchantmentsFunction.enchantments), ((MapCodec)Codec.BOOL.fieldOf("add")).orElse(false).forGetter(setEnchantmentsFunction -> setEnchantmentsFunction.add))).apply((Applicative<SetEnchantmentsFunction, ?>)instance, SetEnchantmentsFunction::new));
