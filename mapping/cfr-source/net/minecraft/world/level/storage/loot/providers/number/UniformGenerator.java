...
{
    public static final MapCodec<UniformGenerator> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)NumberProviders.CODEC.fieldOf("min")).forGetter(UniformGenerator::min), ((MapCodec)NumberProviders.CODEC.fieldOf("max")).forGetter(UniformGenerator::max)).apply((Applicative<UniformGenerator, ?>)instance, UniformGenerator::new));
