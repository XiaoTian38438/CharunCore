...
{
    public static final MapCodec<EntityHasScoreCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.unboundedMap(Codec.STRING, IntRange.CODEC).fieldOf("scores")).forGetter(EntityHasScoreCondition::scores), ((MapCodec)LootContext.EntityTarget.CODEC.fieldOf("entity")).forGetter(EntityHasScoreCondition::entityTarget)).apply((Applicative<EntityHasScoreCondition, ?>)instance, EntityHasScoreCondition::new));
