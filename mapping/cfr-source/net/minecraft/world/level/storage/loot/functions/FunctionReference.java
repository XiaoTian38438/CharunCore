...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<FunctionReference> CODEC = RecordCodecBuilder.mapCodec(instance -> FunctionReference.commonFields(instance).and(((MapCodec)ResourceKey.codec(Registries.ITEM_MODIFIER).fieldOf("name")).forGetter(functionReference -> functionReference.name)).apply((Applicative<FunctionReference, ?>)instance, FunctionReference::new));
