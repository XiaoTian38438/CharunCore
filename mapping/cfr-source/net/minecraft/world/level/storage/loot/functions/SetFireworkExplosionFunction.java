...
extends LootItemConditionalFunction {
    public static final MapCodec<SetFireworkExplosionFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetFireworkExplosionFunction.commonFields(instance).and(instance.group(FireworkExplosion.Shape.CODEC.optionalFieldOf("shape").forGetter(setFireworkExplosionFunction -> setFireworkExplosionFunction.shape), FireworkExplosion.COLOR_LIST_CODEC.optionalFieldOf("colors").forGetter(setFireworkExplosionFunction -> setFireworkExplosionFunction.colors), FireworkExplosion.COLOR_LIST_CODEC.optionalFieldOf("fade_colors").forGetter(setFireworkExplosionFunction -> setFireworkExplosionFunction.fadeColors), Codec.BOOL.optionalFieldOf("trail").forGetter(setFireworkExplosionFunction -> setFireworkExplosionFunction.trail), Codec.BOOL.optionalFieldOf("twinkle").forGetter(setFireworkExplosionFunction -> setFireworkExplosionFunction.twinkle))).apply((Applicative<SetFireworkExplosionFunction, ?>)instance, SetFireworkExplosionFunction::new));
