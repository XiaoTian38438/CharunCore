...
extends LootItemConditionalFunction {
    public static final MapCodec<SetFireworksFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetFireworksFunction.commonFields(instance).and(instance.group(ListOperation.StandAlone.codec(FireworkExplosion.CODEC, 256).optionalFieldOf("explosions").forGetter(setFireworksFunction -> setFireworksFunction.explosions), ExtraCodecs.UNSIGNED_BYTE.optionalFieldOf("flight_duration").forGetter(setFireworksFunction -> setFireworksFunction.flightDuration))).apply((Applicative<SetFireworksFunction, ?>)instance, SetFireworksFunction::new));
