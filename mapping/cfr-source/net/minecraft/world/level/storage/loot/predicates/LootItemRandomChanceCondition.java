...
{
    public static final MapCodec<LootItemRandomChanceCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)NumberProviders.CODEC.fieldOf("chance")).forGetter(LootItemRandomChanceCondition::chance)).apply((Applicative<LootItemRandomChanceCondition, ?>)instance, LootItemRandomChanceCondition::new));
