...
public record ConditionReference(ResourceKey<LootItemCondition> name) implements LootItemCondition
{
    ...
    public static final MapCodec<ConditionReference> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ResourceKey.codec(Registries.PREDICATE).fieldOf("name")).forGetter(ConditionReference::name)).apply((Applicative<ConditionReference, ?>)instance, ConditionReference::new));
