...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<SetNameFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetNameFunction.commonFields(instance).and(instance.group(ComponentSerialization.CODEC.optionalFieldOf("name").forGetter(setNameFunction -> setNameFunction.name), LootContext.EntityTarget.CODEC.optionalFieldOf("entity").forGetter(setNameFunction -> setNameFunction.resolutionContext), Target.CODEC.optionalFieldOf("target", Target.CUSTOM_NAME).forGetter(setNameFunction -> setNameFunction.target))).apply((Applicative<SetNameFunction, ?>)instance, SetNameFunction::new));
