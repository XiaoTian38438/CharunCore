...
extends LootPoolEntryContainer {
    ...
    protected static <T extends LootPoolSingletonContainer> Products.P4<RecordCodecBuilder.Mu<T>, Integer, Integer, List<LootItemCondition>, List<LootItemFunction>> singletonFields(RecordCodecBuilder.Instance<T> instance) {
        return instance.group(Codec.INT.optionalFieldOf("weight", 1).forGetter(lootPoolSingletonContainer -> lootPoolSingletonContainer.weight), Codec.INT.optionalFieldOf("quality", 0).forGetter(lootPoolSingletonContainer -> lootPoolSingletonContainer.quality)).and(LootPoolSingletonContainer.commonFields(instance).t1()).and(LootItemFunctions.ROOT_CODEC.listOf().optionalFieldOf("functions", List.of()).forGetter(lootPoolSingletonContainer -> lootPoolSingletonContainer.functions));
    }
