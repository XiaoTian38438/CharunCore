...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<SetCustomModelDataFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetCustomModelDataFunction.commonFields(instance).and(instance.group(ListOperation.StandAlone.codec(NumberProviders.CODEC, Integer.MAX_VALUE).optionalFieldOf("floats").forGetter(setCustomModelDataFunction -> setCustomModelDataFunction.floats), ListOperation.StandAlone.codec(Codec.BOOL, Integer.MAX_VALUE).optionalFieldOf("flags").forGetter(setCustomModelDataFunction -> setCustomModelDataFunction.flags), ListOperation.StandAlone.codec(Codec.STRING, Integer.MAX_VALUE).optionalFieldOf("strings").forGetter(setCustomModelDataFunction -> setCustomModelDataFunction.strings), ListOperation.StandAlone.codec(COLOR_PROVIDER_CODEC, Integer.MAX_VALUE).optionalFieldOf("colors").forGetter(setCustomModelDataFunction -> setCustomModelDataFunction.colors))).apply((Applicative<SetCustomModelDataFunction, ?>)instance, SetCustomModelDataFunction::new));
