...
implements ValueInput {
    ...
    public <T> Optional<T> read(MapCodec<T> mapCodec) {
        ...
        DataResult dataResult = dynamicOps.getMap(this.input).flatMap(mapLike -> mapCodec.decode(dynamicOps, mapLike));
        Objects.requireNonNull(dataResult);
        DataResult dataResult2 = dataResult;
        int n = 0;
        return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, dataResult2, n)) {
            ...
            return Streams.mapWithIndex(this.list.stream(), (tag, l) -> {
                ...
                return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, dataResult2, n)) {
                    ...
                    case 1 -> {
                        ...
                        this.reportIndexUnwrapProblem((int)l, (Tag)tag, var7_6);
            ...
            return new AbstractIterator<T>(){
                ...
                protected @Nullable T computeNext() {
                    while (listIterator.hasNext()) {
                        ...
                        Objects.requireNonNull(codec.parse(context.ops(), tag));
                        int n2 = 0;
                        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, dataResult, n2)) {
                            default: {
