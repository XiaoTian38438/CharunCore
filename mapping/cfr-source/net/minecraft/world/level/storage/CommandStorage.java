...
public class CommandStorage {
    ...
    extends SavedData {
        public static final Codec<Container> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.unboundedMap(ExtraCodecs.RESOURCE_PATH_CODEC, CompoundTag.CODEC).fieldOf("contents")).forGetter(container -> container.storage)).apply((Applicative<Container, ?>)instance, Container::new));
