...
extends SavedData {
    ...
    public static final Codec<MapIndex> CODEC = RecordCodecBuilder.create(instance -> instance.group(Codec.INT.optionalFieldOf("map", -1).forGetter(mapIndex -> mapIndex.lastMapId)).apply((Applicative<MapIndex, ?>)instance, MapIndex::new));
