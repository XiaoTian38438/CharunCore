...
extends FlowerBlock {
    public static final MapCodec<EyeblossomBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.BOOL.fieldOf("open")).forGetter(eyeblossomBlock -> eyeblossomBlock.type.open), EyeblossomBlock.propertiesCodec()).apply((Applicative<EyeblossomBlock, ?>)instance, EyeblossomBlock::new));
