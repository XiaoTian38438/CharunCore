...
public class RotationSegment {
    ...
    public static Optional<Direction> convertToDirection(int n) {
        Direction direction = switch (n) {
    ...
    public static float convertToDegrees(int n) {
        return SEGMENTED_ANGLE16.toDegrees(n);
    }
}
