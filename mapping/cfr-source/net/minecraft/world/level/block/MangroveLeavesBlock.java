...
implements BonemealableBlock {
    public static final MapCodec<MangroveLeavesBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ExtraCodecs.floatRange(0.0f, 1.0f).fieldOf("leaf_particle_chance")).forGetter(mangroveLeavesBlock -> Float.valueOf(mangroveLeavesBlock.leafParticleChance)), MangroveLeavesBlock.propertiesCodec()).apply((Applicative<MangroveLeavesBlock, ?>)instance, MangroveLeavesBlock::new));
