...
extends LeavesBlock {
    public static final MapCodec<TintedParticleLeavesBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ExtraCodecs.floatRange(0.0f, 1.0f).fieldOf("leaf_particle_chance")).forGetter(tintedParticleLeavesBlock -> Float.valueOf(tintedParticleLeavesBlock.leafParticleChance)), TintedParticleLeavesBlock.propertiesCodec()).apply((Applicative<TintedParticleLeavesBlock, ?>)instance, TintedParticleLeavesBlock::new));
