...
implements BonemealableBlock {
    public static final MapCodec<FungusBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ResourceKey.codec(Registries.CONFIGURED_FEATURE).fieldOf("feature")).forGetter(fungusBlock -> fungusBlock.feature), ((MapCodec)BuiltInRegistries.BLOCK.byNameCodec().fieldOf("grows_on")).forGetter(fungusBlock -> fungusBlock.requiredBlock), FungusBlock.propertiesCodec()).apply((Applicative<FungusBlock, ?>)instance, FungusBlock::new));
