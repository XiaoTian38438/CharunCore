...
extends BaseCoralWallFanBlock {
    public static final MapCodec<CoralWallFanBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(CoralBlock.DEAD_CORAL_FIELD.forGetter(coralWallFanBlock -> coralWallFanBlock.deadBlock), CoralWallFanBlock.propertiesCodec()).apply((Applicative<CoralWallFanBlock, ?>)instance, CoralWallFanBlock::new));
