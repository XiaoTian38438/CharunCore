...
implements WeatheringCopper {
    public static final MapCodec<WeatheringCopperBarsBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state")).forGetter(WeatheringCopperBarsBlock::getAge), WeatheringCopperBarsBlock.propertiesCodec()).apply((Applicative<WeatheringCopperBarsBlock, ?>)instance, WeatheringCopperBarsBlock::new));
