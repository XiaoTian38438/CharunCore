...
implements WeatheringCopper {
    public static final MapCodec<WeatheringCopperGrateBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state")).forGetter(WeatheringCopperGrateBlock::getAge), WeatheringCopperGrateBlock.propertiesCodec()).apply((Applicative<WeatheringCopperGrateBlock, ?>)instance, WeatheringCopperGrateBlock::new));
