...
implements SuspiciousEffectHolder {
    ...
    public static final MapCodec<FlowerBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(EFFECTS_FIELD.forGetter(FlowerBlock::getSuspiciousEffects), FlowerBlock.propertiesCodec()).apply((Applicative<FlowerBlock, ?>)instance, FlowerBlock::new));
