...
extends BaseCoralFanBlock {
    public static final MapCodec<CoralFanBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(CoralBlock.DEAD_CORAL_FIELD.forGetter(coralFanBlock -> coralFanBlock.deadBlock), CoralFanBlock.propertiesCodec()).apply((Applicative<CoralFanBlock, ?>)instance, CoralFanBlock::new));
