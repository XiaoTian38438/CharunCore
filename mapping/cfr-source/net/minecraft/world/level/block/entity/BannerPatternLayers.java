...
implements TooltipProvider {
    ...
    public record Layer(Holder<BannerPattern> pattern, DyeColor color) {
        public static final Codec<Layer> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BannerPattern.CODEC.fieldOf("pattern")).forGetter(Layer::pattern), ((MapCodec)DyeColor.CODEC.fieldOf("color")).forGetter(Layer::color)).apply((Applicative<Layer, ?>)instance, Layer::new));
