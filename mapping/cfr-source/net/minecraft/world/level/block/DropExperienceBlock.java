...
extends Block {
    public static final MapCodec<DropExperienceBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)IntProvider.codec(0, 10).fieldOf("experience")).forGetter(dropExperienceBlock -> dropExperienceBlock.xpRange), DropExperienceBlock.propertiesCodec()).apply((Applicative<DropExperienceBlock, ?>)instance, DropExperienceBlock::new));
