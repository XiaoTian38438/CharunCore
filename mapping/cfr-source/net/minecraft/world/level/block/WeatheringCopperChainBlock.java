...
implements WeatheringCopper {
    public static final MapCodec<WeatheringCopperChainBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state")).forGetter(WeatheringCopperChainBlock::getAge), WeatheringCopperChainBlock.propertiesCodec()).apply((Applicative<WeatheringCopperChainBlock, ?>)instance, WeatheringCopperChainBlock::new));
