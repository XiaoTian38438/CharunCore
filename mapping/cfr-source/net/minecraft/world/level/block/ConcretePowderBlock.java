...
extends FallingBlock {
    public static final MapCodec<ConcretePowderBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)BuiltInRegistries.BLOCK.byNameCodec().fieldOf("concrete")).forGetter(concretePowderBlock -> concretePowderBlock.concrete), ConcretePowderBlock.propertiesCodec()).apply((Applicative<ConcretePowderBlock, ?>)instance, ConcretePowderBlock::new));
