...
public final class Biome {
    public static final Codec<Biome> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(ClimateSettings.CODEC.forGetter(biome -> biome.climateSettings), EnvironmentAttributeMap.CODEC_ONLY_POSITIONAL.optionalFieldOf("attributes", EnvironmentAttributeMap.EMPTY).forGetter(biome -> biome.attributes), ((MapCodec)BiomeSpecialEffects.CODEC.fieldOf("effects")).forGetter(biome -> biome.specialEffects), BiomeGenerationSettings.CODEC.forGetter(biome -> biome.generationSettings), MobSpawnSettings.CODEC.forGetter(biome -> biome.mobSettings)).apply((Applicative<Biome, ?>)instance, Biome::new));
    public static final Codec<Biome> NETWORK_CODEC = RecordCodecBuilder.create(instance -> instance.group(ClimateSettings.CODEC.forGetter(biome -> biome.climateSettings), EnvironmentAttributeMap.NETWORK_CODEC.optionalFieldOf("attributes", EnvironmentAttributeMap.EMPTY).forGetter(biome -> biome.attributes), ((MapCodec)BiomeSpecialEffects.CODEC.fieldOf("effects")).forGetter(biome -> biome.specialEffects)).apply((Applicative<Biome, ?>)instance, (climateSettings, environmentAttributeMap, biomeSpecialEffects) -> new Biome((ClimateSettings)climateSettings, (EnvironmentAttributeMap)environmentAttributeMap, (BiomeSpecialEffects)biomeSpecialEffects, BiomeGenerationSettings.EMPTY, MobSpawnSettings.EMPTY)));
    ...
    public int getGrassColor(double d, double d2) {
        ...
        return this.specialEffects.grassColorModifier().modifyColor(d, d2, n);
    }
    ...
    public static class BiomeBuilder {
        ...
        public <Value> BiomeBuilder setAttribute(EnvironmentAttribute<Value> environmentAttribute, Value Value2) {
            this.attributes.set(environmentAttribute, Value2);
            return this;
        }

        public <Value, Parameter> BiomeBuilder modifyAttribute(EnvironmentAttribute<Value> environmentAttribute, AttributeModifier<Value, Parameter> attributeModifier, Parameter Parameter2) {
            this.attributes.modify(environmentAttribute, attributeModifier, Parameter2);
            return this;
        }
