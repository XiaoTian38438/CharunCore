...
public final class OverworldBiomeBuilder {
    ...
    private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer) {
        ...
        CubicSpline cubicSpline2 = TerrainProvider.buildErosionOffsetSpline(coordinate2, coordinate3, -0.15f, 0.0f, 0.0f, 0.1f, 0.0f, -0.03f, false, false, BoundedFloatFunction.IDENTITY);
