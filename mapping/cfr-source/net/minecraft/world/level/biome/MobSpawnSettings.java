...
public class MobSpawnSettings {
    ...
    public record SpawnerData(EntityType<?> type, int minCount, int maxCount) {
        public static final MapCodec<SpawnerData> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)BuiltInRegistries.ENTITY_TYPE.byNameCodec().fieldOf("type")).forGetter(spawnerData -> spawnerData.type), ((MapCodec)ExtraCodecs.POSITIVE_INT.fieldOf("minCount")).forGetter(spawnerData -> spawnerData.minCount), ((MapCodec)ExtraCodecs.POSITIVE_INT.fieldOf("maxCount")).forGetter(spawnerData -> spawnerData.maxCount)).apply((Applicative<SpawnerData, ?>)instance, SpawnerData::new)).validate(spawnerData -> {
