...
public class MultiNoiseBiomeSourceParameterList {
    ...
    extends Record {
        ...
        public static final Codec<Preset> CODEC = Identifier.CODEC.flatXmap(identifier -> Optional.ofNullable(BY_NAME.get(identifier)).map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Unknown preset: " + String.valueOf(identifier))), preset -> DataResult.success(preset.id));
