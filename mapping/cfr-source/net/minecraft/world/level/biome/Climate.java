...
public class Climate {
    ...
    public record Parameter(long min, long max) {
        public static final Codec<Parameter> CODEC = ExtraCodecs.intervalCodec(Codec.floatRange(-2.0f, 2.0f), "min", "max", (f, f2) -> {
            ...
            return DataResult.success(new Parameter(Climate.quantizeCoord(f.floatValue()), Climate.quantizeCoord(f2.floatValue())));
    ...
    public static class ParameterList<T> {
        ...
        public T findValueBruteForce(TargetPoint targetPoint) {
            ...
            while (iterator.hasNext()) {
                ...
                long l2 = pair2.getFirst().fitness(targetPoint);
                if (l2 >= l) continue;
                l = l2;
                t = pair2.getSecond();
            }
    ...
    protected static final class RTree<T> {
        ...
        public static <T> RTree<T> create(List<Pair<ParameterPoint, T>> list) {
            ...
            int n = list.get(0).getFirst().parameterSpace().size();
            if (n != 7) {
