...
extends StructureProcessor {
    public static final MapCodec<RuleProcessor> CODEC = ((MapCodec)ProcessorRule.CODEC.listOf().fieldOf("rules")).xmap(RuleProcessor::new, ruleProcessor -> ruleProcessor.rules);
