...
public class ShipwreckPieces {
    ...
    extends TemplateStructurePiece {
        ...
        public ShipwreckPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
            super(StructurePieceType.SHIPWRECK_PIECE, compoundTag, structureTemplateManager, identifier -> ShipwreckPiece.makeSettings(compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
