...
extends SinglePoolElement {
    public static final MapCodec<LegacySinglePoolElement> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(LegacySinglePoolElement.templateCodec(), LegacySinglePoolElement.processorsCodec(), LegacySinglePoolElement.projectionCodec(), LegacySinglePoolElement.overrideLiquidSettingsCodec()).apply(instance, LegacySinglePoolElement::new));
