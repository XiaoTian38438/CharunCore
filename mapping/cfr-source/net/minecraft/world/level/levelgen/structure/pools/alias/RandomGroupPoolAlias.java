...
{
    static MapCodec<RandomGroupPoolAlias> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)WeightedList.nonEmptyCodec(Codec.list(PoolAliasBinding.CODEC)).fieldOf("groups")).forGetter(RandomGroupPoolAlias::groups)).apply((Applicative<RandomGroupPoolAlias, ?>)instance, RandomGroupPoolAlias::new));
