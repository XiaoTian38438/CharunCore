...
public class StructureCheck {
    ...
    private @Nullable StructureCheckResult tryLoadFromStorage(ChunkPos chunkPos, Structure structure, boolean bl, long l) {
        ...
        SimpleRegionStorage.injectDatafixingContext(compoundTag2, ChunkMap.getChunkDataFixContextTag(this.dimension, this.chunkGenerator.getTypeNameForDataFixer()));
        try {
