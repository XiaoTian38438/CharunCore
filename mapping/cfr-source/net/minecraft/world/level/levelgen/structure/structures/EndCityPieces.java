...
public class EndCityPieces {
    ...
    extends TemplateStructurePiece {
        ...
        public EndCityPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
            super(StructurePieceType.END_CITY_PIECE, compoundTag, structureTemplateManager, identifier -> EndCityPiece.makeSettings(compoundTag.getBooleanOr("OW", false), compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
        }
