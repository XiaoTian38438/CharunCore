...
extends RuleTest {
    public static final MapCodec<TagMatchTest> CODEC = ((MapCodec)TagKey.codec(Registries.BLOCK).fieldOf("tag")).xmap(TagMatchTest::new, tagMatchTest -> tagMatchTest.tag);
