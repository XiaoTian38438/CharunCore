...
implements RuleBlockEntityModifier {
    public static final MapCodec<AppendStatic> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)CompoundTag.CODEC.fieldOf("data")).forGetter(appendStatic -> appendStatic.tag)).apply((Applicative<AppendStatic, ?>)instance, AppendStatic::new));
