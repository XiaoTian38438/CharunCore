...
extends RuleTest {
    public static final MapCodec<BlockMatchTest> CODEC = ((MapCodec)BuiltInRegistries.BLOCK.byNameCodec().fieldOf("block")).xmap(BlockMatchTest::new, blockMatchTest -> blockMatchTest.block);
