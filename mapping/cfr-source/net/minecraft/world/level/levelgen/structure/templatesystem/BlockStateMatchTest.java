...
extends RuleTest {
    public static final MapCodec<BlockStateMatchTest> CODEC = ((MapCodec)BlockState.CODEC.fieldOf("block_state")).xmap(BlockStateMatchTest::new, blockStateMatchTest -> blockStateMatchTest.blockState);
