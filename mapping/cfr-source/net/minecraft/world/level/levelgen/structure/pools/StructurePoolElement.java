...
public abstract class StructurePoolElement {
    ...
    public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(String string) {
        return projection -> new LegacySinglePoolElement(Either.left(Identifier.parse(string)), EMPTY, (StructureTemplatePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(String string, Holder<StructureProcessorList> holder) {
        return projection -> new LegacySinglePoolElement(Either.left(Identifier.parse(string)), holder, (StructureTemplatePool.Projection)projection, Optional.empty());
    }

    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String string) {
        return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), EMPTY, (StructureTemplatePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String string, Holder<StructureProcessorList> holder) {
        return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), holder, (StructureTemplatePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String string, LiquidSettings liquidSettings) {
        return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), EMPTY, (StructureTemplatePool.Projection)projection, Optional.of(liquidSettings));
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String string, Holder<StructureProcessorList> holder, LiquidSettings liquidSettings) {
        return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), holder, (StructureTemplatePool.Projection)projection, Optional.of(liquidSettings));
    }
