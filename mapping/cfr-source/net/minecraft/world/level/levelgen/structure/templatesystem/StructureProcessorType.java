...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    public static final Codec<StructureProcessorList> DIRECT_CODEC = Codec.withAlternative(((MapCodec)LIST_OBJECT_CODEC.fieldOf("processors")).codec(), LIST_OBJECT_CODEC);
