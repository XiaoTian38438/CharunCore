...
extends Structure {
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext generationContext) {
        ...
        return Optional.of(new Structure.GenerationStub(blockPos.offset(0, n, 0), Either.right(structurePiecesBuilder)));
    }
