...
public class NetherFossilPieces {
    ...
    extends TemplateStructurePiece {
        ...
        public NetherFossilPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
            super(StructurePieceType.NETHER_FOSSIL, compoundTag, structureTemplateManager, (Identifier identifier) -> NetherFossilPiece.makeSettings(compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
        }
