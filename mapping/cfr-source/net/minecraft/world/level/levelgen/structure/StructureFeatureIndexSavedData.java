...
extends SavedData {
    ...
    public static final Codec<StructureFeatureIndexSavedData> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)LONG_SET.fieldOf("All")).forGetter(structureFeatureIndexSavedData -> structureFeatureIndexSavedData.all), ((MapCodec)LONG_SET.fieldOf("Remaining")).forGetter(structureFeatureIndexSavedData -> structureFeatureIndexSavedData.remaining)).apply((Applicative<StructureFeatureIndexSavedData, ?>)instance, StructureFeatureIndexSavedData::new));
