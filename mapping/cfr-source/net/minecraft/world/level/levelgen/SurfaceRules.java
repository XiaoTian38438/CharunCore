...
public class SurfaceRules {
    ...
    {
        static final KeyDispatchDataCodec<VerticalGradientConditionSource> CODEC = KeyDispatchDataCodec.of(RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Identifier.CODEC.fieldOf("random_name")).forGetter(VerticalGradientConditionSource::randomName), ((MapCodec)VerticalAnchor.CODEC.fieldOf("true_at_and_below")).forGetter(VerticalGradientConditionSource::trueAtAndBelow), ((MapCodec)VerticalAnchor.CODEC.fieldOf("false_at_and_above")).forGetter(VerticalGradientConditionSource::falseAtAndAbove)).apply((Applicative<VerticalGradientConditionSource, ?>)instance, VerticalGradientConditionSource::new)));
    ...
    {
        @Override
        public @Nullable BlockState tryApply(int n, int n2, int n3) {
