...
extends PlacementFilter {
    public static final MapCodec<BlockPredicateFilter> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)BlockPredicate.CODEC.fieldOf("predicate")).forGetter(blockPredicateFilter -> blockPredicateFilter.predicate)).apply((Applicative<BlockPredicateFilter, ?>)instance, BlockPredicateFilter::new));
