...
extends PlacementModifier {
    public static final MapCodec<HeightRangePlacement> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)HeightProvider.CODEC.fieldOf("height")).forGetter(heightRangePlacement -> heightRangePlacement.height)).apply((Applicative<HeightRangePlacement, ?>)instance, HeightRangePlacement::new));
