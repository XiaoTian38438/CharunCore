...
extends RepeatingPlacement {
    public static final MapCodec<CountPlacement> CODEC = ((MapCodec)IntProvider.codec(0, 256).fieldOf("count")).xmap(CountPlacement::new, countPlacement -> countPlacement.count);
