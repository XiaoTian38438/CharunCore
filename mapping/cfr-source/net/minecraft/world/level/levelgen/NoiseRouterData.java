...
public class NoiseRouterData {
    ...
    private static DensityFunction remap(DensityFunction densityFunction, double d, double d2, double d3, double d4) {
        double d5 = (d4 - d3) / (d2 - d);
        double d6 = d3 - d * d5;
        return DensityFunctions.add(DensityFunctions.mul(densityFunction, DensityFunctions.constant(d5)), DensityFunctions.constant(d6));
    }
    ...
    protected static NoiseRouter overworld(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, boolean bl, boolean bl2) {
        ...
        DensityFunction densityFunction18 = NoiseRouterData.yLimitedInterpolatable(densityFunction17, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEININESS), 1.5, 1.5), n, n2, 0);
        float f = 4.0f;
        DensityFunction densityFunction19 = NoiseRouterData.yLimitedInterpolatable(densityFunction17, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_A), 4.0, 4.0), n, n2, 0).abs();
        DensityFunction densityFunction20 = NoiseRouterData.yLimitedInterpolatable(densityFunction17, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_B), 4.0, 4.0), n, n2, 0).abs();
