...
public final class ImprovedNoise {
    ...
    public double noise(double d, double d2, double d3, double d4, double d5) {
        ...
        if (d4 != 0.0) {
            ...
            d6 = (double)Mth.floor(d13 / d4 + (double)1.0E-7f) * d4;
        } else {
            d6 = 0.0;
        }
    ...
    private double sampleAndLerp(int n, int n2, int n3, double d, double d2, double d3, double d4) {
        ...
        double d13 = Mth.smoothstep(d);
        double d14 = Mth.smoothstep(d4);
        double d15 = Mth.smoothstep(d3);
    ...
    private double sampleWithDerivative(int n, int n2, int n3, double d, double d2, double d3, double[] dArray) {
        ...
        double d12 = Mth.smoothstep(d);
        double d13 = Mth.smoothstep(d2);
        double d14 = Mth.smoothstep(d3);
        double d15 = Mth.lerp3(d12, d13, d14, nArray[0], nArray2[0], nArray3[0], nArray4[0], nArray5[0], nArray6[0], nArray7[0], nArray8[0]);
        double d16 = Mth.lerp3(d12, d13, d14, nArray[1], nArray2[1], nArray3[1], nArray4[1], nArray5[1], nArray6[1], nArray7[1], nArray8[1]);
        double d17 = Mth.lerp3(d12, d13, d14, nArray[2], nArray2[2], nArray3[2], nArray4[2], nArray5[2], nArray6[2], nArray7[2], nArray8[2]);
        double d18 = Mth.lerp2(d13, d14, d5 - d4, d7 - d6, d9 - d8, d11 - d10);
        double d19 = Mth.lerp2(d14, d12, d6 - d4, d10 - d8, d7 - d5, d11 - d9);
        double d20 = Mth.lerp2(d12, d13, d8 - d4, d9 - d5, d10 - d6, d11 - d7);
        double d21 = Mth.smoothstepDerivative(d);
        double d22 = Mth.smoothstepDerivative(d2);
        double d23 = Mth.smoothstepDerivative(d3);
