...
extends ChunkGenerator {
    public static final MapCodec<FlatLevelSource> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)FlatLevelGeneratorSettings.CODEC.fieldOf("settings")).forGetter(FlatLevelSource::settings)).apply((Applicative<FlatLevelSource, ?>)instance, instance.stable(FlatLevelSource::new)));
