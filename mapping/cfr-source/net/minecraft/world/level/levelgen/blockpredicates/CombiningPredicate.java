...
implements BlockPredicate {
    ...
    public static <T extends CombiningPredicate> MapCodec<T> codec(Function<List<BlockPredicate>, T> function) {
        return RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)BlockPredicate.CODEC.listOf().fieldOf("predicates")).forGetter(combiningPredicate -> combiningPredicate.predicates)).apply((Applicative<CombiningPredicate, ?>)instance, function));
    }
}
