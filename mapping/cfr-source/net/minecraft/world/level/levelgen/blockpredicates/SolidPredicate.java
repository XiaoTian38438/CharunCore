...
extends StateTestingPredicate {
    public static final MapCodec<SolidPredicate> CODEC = RecordCodecBuilder.mapCodec(instance -> SolidPredicate.stateTestingCodec(instance).apply(instance, SolidPredicate::new));
