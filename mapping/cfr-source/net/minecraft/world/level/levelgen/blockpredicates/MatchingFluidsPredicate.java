...
extends StateTestingPredicate {
    ...
    public static final MapCodec<MatchingFluidsPredicate> CODEC = RecordCodecBuilder.mapCodec(instance -> MatchingFluidsPredicate.stateTestingCodec(instance).and(((MapCodec)RegistryCodecs.homogeneousList(Registries.FLUID).fieldOf("fluids")).forGetter(matchingFluidsPredicate -> matchingFluidsPredicate.fluids)).apply((Applicative<MatchingFluidsPredicate, ?>)instance, MatchingFluidsPredicate::new));
