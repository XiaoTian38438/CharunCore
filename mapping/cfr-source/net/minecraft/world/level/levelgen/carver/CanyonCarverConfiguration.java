...
extends CarverConfiguration {
    ...
    public static class CanyonShapeConfiguration {
        public static final Codec<CanyonShapeConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)FloatProvider.CODEC.fieldOf("distance_factor")).forGetter(canyonShapeConfiguration -> canyonShapeConfiguration.distanceFactor), ((MapCodec)FloatProvider.CODEC.fieldOf("thickness")).forGetter(canyonShapeConfiguration -> canyonShapeConfiguration.thickness), ((MapCodec)ExtraCodecs.POSITIVE_INT.fieldOf("width_smoothness")).forGetter(canyonShapeConfiguration -> canyonShapeConfiguration.widthSmoothness), ((MapCodec)FloatProvider.CODEC.fieldOf("horizontal_radius_factor")).forGetter(canyonShapeConfiguration -> canyonShapeConfiguration.horizontalRadiusFactor), ((MapCodec)Codec.FLOAT.fieldOf("vertical_radius_default_factor")).forGetter(canyonShapeConfiguration -> Float.valueOf(canyonShapeConfiguration.verticalRadiusDefaultFactor)), ((MapCodec)Codec.FLOAT.fieldOf("vertical_radius_center_factor")).forGetter(canyonShapeConfiguration -> Float.valueOf(canyonShapeConfiguration.verticalRadiusCenterFactor))).apply((Applicative<CanyonShapeConfiguration, ?>)instance, CanyonShapeConfiguration::new));
