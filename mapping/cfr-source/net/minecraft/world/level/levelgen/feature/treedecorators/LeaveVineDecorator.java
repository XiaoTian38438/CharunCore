...
extends TreeDecorator {
    public static final MapCodec<LeaveVineDecorator> CODEC = ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("probability")).xmap(LeaveVineDecorator::new, leaveVineDecorator -> Float.valueOf(leaveVineDecorator.probability));
