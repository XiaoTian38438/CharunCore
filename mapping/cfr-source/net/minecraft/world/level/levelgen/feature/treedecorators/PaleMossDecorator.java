...
extends TreeDecorator {
    public static final MapCodec<PaleMossDecorator> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("leaves_probability")).forGetter(paleMossDecorator -> Float.valueOf(paleMossDecorator.leavesProbability)), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("trunk_probability")).forGetter(paleMossDecorator -> Float.valueOf(paleMossDecorator.trunkProbability)), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("ground_probability")).forGetter(paleMossDecorator -> Float.valueOf(paleMossDecorator.groundProbability))).apply((Applicative<PaleMossDecorator, ?>)instance, PaleMossDecorator::new));
