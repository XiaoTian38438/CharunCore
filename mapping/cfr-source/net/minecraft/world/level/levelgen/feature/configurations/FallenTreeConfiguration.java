...
implements FeatureConfiguration {
    public static final Codec<FallenTreeConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockStateProvider.CODEC.fieldOf("trunk_provider")).forGetter(fallenTreeConfiguration -> fallenTreeConfiguration.trunkProvider), ((MapCodec)IntProvider.codec(0, 16).fieldOf("log_length")).forGetter(fallenTreeConfiguration -> fallenTreeConfiguration.logLength), ((MapCodec)TreeDecorator.CODEC.listOf().fieldOf("stump_decorators")).forGetter(fallenTreeConfiguration -> fallenTreeConfiguration.stumpDecorators), ((MapCodec)TreeDecorator.CODEC.listOf().fieldOf("log_decorators")).forGetter(fallenTreeConfiguration -> fallenTreeConfiguration.logDecorators)).apply((Applicative<FallenTreeConfiguration, ?>)instance, FallenTreeConfiguration::new));
