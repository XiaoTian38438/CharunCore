...
extends TreeDecorator {
    public static final MapCodec<AttachedToLogsDecorator> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("probability")).forGetter(attachedToLogsDecorator -> Float.valueOf(attachedToLogsDecorator.probability)), ((MapCodec)BlockStateProvider.CODEC.fieldOf("block_provider")).forGetter(attachedToLogsDecorator -> attachedToLogsDecorator.blockProvider), ((MapCodec)ExtraCodecs.nonEmptyList(Direction.CODEC.listOf()).fieldOf("directions")).forGetter(attachedToLogsDecorator -> attachedToLogsDecorator.directions)).apply((Applicative<AttachedToLogsDecorator, ?>)instance, AttachedToLogsDecorator::new));
