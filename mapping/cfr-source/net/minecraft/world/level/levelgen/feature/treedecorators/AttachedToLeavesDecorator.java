...
extends TreeDecorator {
    public static final MapCodec<AttachedToLeavesDecorator> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("probability")).forGetter(attachedToLeavesDecorator -> Float.valueOf(attachedToLeavesDecorator.probability)), ((MapCodec)Codec.intRange(0, 16).fieldOf("exclusion_radius_xz")).forGetter(attachedToLeavesDecorator -> attachedToLeavesDecorator.exclusionRadiusXZ), ((MapCodec)Codec.intRange(0, 16).fieldOf("exclusion_radius_y")).forGetter(attachedToLeavesDecorator -> attachedToLeavesDecorator.exclusionRadiusY), ((MapCodec)BlockStateProvider.CODEC.fieldOf("block_provider")).forGetter(attachedToLeavesDecorator -> attachedToLeavesDecorator.blockProvider), ((MapCodec)Codec.intRange(1, 16).fieldOf("required_empty_blocks")).forGetter(attachedToLeavesDecorator -> attachedToLeavesDecorator.requiredEmptyBlocks), ((MapCodec)ExtraCodecs.nonEmptyList(Direction.CODEC.listOf()).fieldOf("directions")).forGetter(attachedToLeavesDecorator -> attachedToLeavesDecorator.directions)).apply((Applicative<AttachedToLeavesDecorator, ?>)instance, AttachedToLeavesDecorator::new));
