...
extends BlockStateProvider {
    public static final MapCodec<RotatedBlockProvider> CODEC = ((MapCodec)BlockState.CODEC.fieldOf("state")).xmap(BlockBehaviour.BlockStateBase::getBlock, Block::defaultBlockState).xmap(RotatedBlockProvider::new, rotatedBlockProvider -> rotatedBlockProvider.block);
