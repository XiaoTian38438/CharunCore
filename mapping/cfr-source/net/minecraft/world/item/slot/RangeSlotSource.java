...
implements SlotSource {
    public static final MapCodec<RangeSlotSource> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)LootContextArg.ENTITY_OR_BLOCK.fieldOf("source")).forGetter(rangeSlotSource -> rangeSlotSource.source), ((MapCodec)SlotRanges.CODEC.fieldOf("slots")).forGetter(rangeSlotSource -> rangeSlotSource.slotRange)).apply((Applicative<RangeSlotSource, ?>)instance, RangeSlotSource::new));
