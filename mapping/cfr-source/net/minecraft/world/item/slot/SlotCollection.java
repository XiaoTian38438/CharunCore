...
public interface SlotCollection {
    ...
    default public SlotCollection limit(int n) {
        return new Limited(this, n);
    }
    ...
    public record Limited(SlotCollection slots, int limit) implements SlotCollection
    {
        ...
        @Override
        public SlotCollection limit(int n) {
            return new Limited(this.slots, Math.min(this.limit, n));
        }
    }
}
