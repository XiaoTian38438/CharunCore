...
implements SlotSource {
    ...
    protected static <T extends CompositeSlotSource> MapCodec<T> createCodec(Function<List<SlotSource>, T> function) {
        return RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)SlotSources.CODEC.listOf().fieldOf("terms")).forGetter(compositeSlotSource -> compositeSlotSource.terms)).apply((Applicative<CompositeSlotSource, ?>)instance, function));
    }
