...
extends TransformedSlotSource {
    public static final MapCodec<FilteredSlotSource> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> FilteredSlotSource.commonFields(instance).and(((MapCodec)ItemPredicate.CODEC.fieldOf("item_filter")).forGetter(filteredSlotSource -> filteredSlotSource.filter)).apply((Applicative<FilteredSlotSource, ?>)instance, FilteredSlotSource::new));
