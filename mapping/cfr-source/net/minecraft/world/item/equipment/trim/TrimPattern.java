...
public record TrimPattern(Identifier assetId, Component description, boolean decal) {
    public static final Codec<TrimPattern> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Identifier.CODEC.fieldOf("asset_id")).forGetter(TrimPattern::assetId), ((MapCodec)ComponentSerialization.CODEC.fieldOf("description")).forGetter(TrimPattern::description), ((MapCodec)Codec.BOOL.fieldOf("decal")).orElse(false).forGetter(TrimPattern::decal)).apply((Applicative<TrimPattern, ?>)instance, TrimPattern::new));
