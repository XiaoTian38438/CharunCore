...
public record TrimMaterial(MaterialAssetGroup assets, Component description) {
    public static final Codec<TrimMaterial> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(MaterialAssetGroup.MAP_CODEC.forGetter(TrimMaterial::assets), ((MapCodec)ComponentSerialization.CODEC.fieldOf("description")).forGetter(TrimMaterial::description)).apply((Applicative<TrimMaterial, ?>)instance, TrimMaterial::new));
