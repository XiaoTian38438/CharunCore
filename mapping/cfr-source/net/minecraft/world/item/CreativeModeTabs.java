...
public class CreativeModeTabs {
    ...
    public static void validate() {
        HashMap<Pair<CreativeModeTab.Row, Integer>, String> hashMap = new HashMap<Pair<CreativeModeTab.Row, Integer>, String>();
        for (ResourceKey<CreativeModeTab> resourceKey : BuiltInRegistries.CREATIVE_MODE_TAB.registryKeySet()) {
            ...
            String string2 = hashMap.put(Pair.of(creativeModeTab.row(), creativeModeTab.column()), string);
