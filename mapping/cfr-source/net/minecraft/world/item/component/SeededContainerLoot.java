...
public record SeededContainerLoot(ResourceKey<LootTable> lootTable, long seed) implements TooltipProvider
{
    ...
    public static final Codec<SeededContainerLoot> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)LootTable.KEY_CODEC.fieldOf("loot_table")).forGetter(SeededContainerLoot::lootTable), Codec.LONG.optionalFieldOf("seed", 0L).forGetter(SeededContainerLoot::seed)).apply((Applicative<SeededContainerLoot, ?>)instance, SeededContainerLoot::new));
