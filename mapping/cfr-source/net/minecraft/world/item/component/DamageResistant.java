...
public record DamageResistant(TagKey<DamageType> types) {
    public static final Codec<DamageResistant> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)TagKey.hashedCodec(Registries.DAMAGE_TYPE).fieldOf("types")).forGetter(DamageResistant::types)).apply((Applicative<DamageResistant, ?>)instance, DamageResistant::new));
