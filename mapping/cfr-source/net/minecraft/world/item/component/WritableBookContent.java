...
public record WritableBookContent(List<Filterable<String>> pages) implements BookContent<String, WritableBookContent>
{
    ...
    public static final Codec<WritableBookContent> CODEC = RecordCodecBuilder.create(instance -> instance.group(PAGES_CODEC.optionalFieldOf("pages", List.of()).forGetter(WritableBookContent::pages)).apply((Applicative<WritableBookContent, ?>)instance, WritableBookContent::new));
