...
TooltipProvider
{
    ...
    public record Entry(Holder<MobEffect> effect, int duration) {
        public static final Codec<Entry> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)MobEffect.CODEC.fieldOf("id")).forGetter(Entry::effect), Codec.INT.lenientOptionalFieldOf("duration", 160).forGetter(Entry::duration)).apply((Applicative<Entry, ?>)instance, Entry::new));
