...
implements CraftingRecipe {
    ...
    implements RecipeSerializer<T> {
        private final MapCodec<T> codec = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)CraftingBookCategory.CODEC.fieldOf("category")).orElse(CraftingBookCategory.MISC).forGetter(CraftingRecipe::category)).apply((Applicative<CraftingRecipe, ?>)instance, factory::create));
