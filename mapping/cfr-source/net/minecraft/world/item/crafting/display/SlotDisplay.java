...
public interface SlotDisplay {
    ...
    {
        public static final MapCodec<WithRemainder> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)CODEC.fieldOf("input")).forGetter(WithRemainder::input), ((MapCodec)CODEC.fieldOf("remainder")).forGetter(WithRemainder::remainder)).apply((Applicative<WithRemainder, ?>)instance, WithRemainder::new));
    ...
    {
        public static final MapCodec<Composite> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)CODEC.listOf().fieldOf("contents")).forGetter(Composite::contents)).apply((Applicative<Composite, ?>)instance, Composite::new));
    ...
    {
        public static final MapCodec<TagSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)TagKey.codec(Registries.ITEM).fieldOf("tag")).forGetter(TagSlotDisplay::tag)).apply((Applicative<TagSlotDisplay, ?>)instance, TagSlotDisplay::new));
    ...
    {
        public static final MapCodec<ItemStackSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ItemStack.STRICT_CODEC.fieldOf("item")).forGetter(ItemStackSlotDisplay::stack)).apply((Applicative<ItemStackSlotDisplay, ?>)instance, ItemStackSlotDisplay::new));
    ...
    {
        public static final MapCodec<ItemSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Item.CODEC.fieldOf("item")).forGetter(ItemSlotDisplay::item)).apply((Applicative<ItemSlotDisplay, ?>)instance, ItemSlotDisplay::new));
    ...
    {
        public static final MapCodec<SmithingTrimDemoSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)CODEC.fieldOf("base")).forGetter(SmithingTrimDemoSlotDisplay::base), ((MapCodec)CODEC.fieldOf("material")).forGetter(SmithingTrimDemoSlotDisplay::material), ((MapCodec)TrimPattern.CODEC.fieldOf("pattern")).forGetter(SmithingTrimDemoSlotDisplay::pattern)).apply((Applicative<SmithingTrimDemoSlotDisplay, ?>)instance, SmithingTrimDemoSlotDisplay::new));
