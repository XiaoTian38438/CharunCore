...
implements CraftingRecipe {
    ...
    implements RecipeSerializer<ShapelessRecipe> {
        private static final MapCodec<ShapelessRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.STRING.optionalFieldOf("group", "").forGetter(shapelessRecipe -> shapelessRecipe.group), ((MapCodec)CraftingBookCategory.CODEC.fieldOf("category")).orElse(CraftingBookCategory.MISC).forGetter(shapelessRecipe -> shapelessRecipe.category), ((MapCodec)ItemStack.STRICT_CODEC.fieldOf("result")).forGetter(shapelessRecipe -> shapelessRecipe.result), ((MapCodec)Ingredient.CODEC.listOf(1, 9).fieldOf("ingredients")).forGetter(shapelessRecipe -> shapelessRecipe.ingredients)).apply((Applicative<ShapelessRecipe, ?>)instance, ShapelessRecipe::new));
