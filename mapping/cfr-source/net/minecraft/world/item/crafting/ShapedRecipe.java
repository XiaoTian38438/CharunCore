...
implements CraftingRecipe {
    ...
    implements RecipeSerializer<ShapedRecipe> {
        public static final MapCodec<ShapedRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.STRING.optionalFieldOf("group", "").forGetter(shapedRecipe -> shapedRecipe.group), ((MapCodec)CraftingBookCategory.CODEC.fieldOf("category")).orElse(CraftingBookCategory.MISC).forGetter(shapedRecipe -> shapedRecipe.category), ShapedRecipePattern.MAP_CODEC.forGetter(shapedRecipe -> shapedRecipe.pattern), ((MapCodec)ItemStack.STRICT_CODEC.fieldOf("result")).forGetter(shapedRecipe -> shapedRecipe.result), Codec.BOOL.optionalFieldOf("show_notification", true).forGetter(shapedRecipe -> shapedRecipe.showNotification)).apply((Applicative<ShapedRecipe, ?>)instance, ShapedRecipe::new));
