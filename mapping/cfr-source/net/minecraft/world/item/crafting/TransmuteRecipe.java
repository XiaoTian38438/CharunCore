...
implements CraftingRecipe {
    ...
    implements RecipeSerializer<TransmuteRecipe> {
        private static final MapCodec<TransmuteRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.STRING.optionalFieldOf("group", "").forGetter(transmuteRecipe -> transmuteRecipe.group), ((MapCodec)CraftingBookCategory.CODEC.fieldOf("category")).orElse(CraftingBookCategory.MISC).forGetter(transmuteRecipe -> transmuteRecipe.category), ((MapCodec)Ingredient.CODEC.fieldOf("input")).forGetter(transmuteRecipe -> transmuteRecipe.input), ((MapCodec)Ingredient.CODEC.fieldOf("material")).forGetter(transmuteRecipe -> transmuteRecipe.material), ((MapCodec)TransmuteResult.CODEC.fieldOf("result")).forGetter(transmuteRecipe -> transmuteRecipe.result)).apply((Applicative<TransmuteRecipe, ?>)instance, TransmuteRecipe::new));
