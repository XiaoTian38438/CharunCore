...
extends SingleItemRecipe {
    ...
    implements RecipeSerializer<T> {
        private final MapCodec<T> codec = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.STRING.optionalFieldOf("group", "").forGetter(SingleItemRecipe::group), ((MapCodec)CookingBookCategory.CODEC.fieldOf("category")).orElse(CookingBookCategory.MISC).forGetter(AbstractCookingRecipe::category), ((MapCodec)Ingredient.CODEC.fieldOf("ingredient")).forGetter(SingleItemRecipe::input), ((MapCodec)ItemStack.STRICT_SINGLE_ITEM_CODEC.fieldOf("result")).forGetter(SingleItemRecipe::result), ((MapCodec)Codec.FLOAT.fieldOf("experience")).orElse(Float.valueOf(0.0f)).forGetter(AbstractCookingRecipe::experience), ((MapCodec)Codec.INT.fieldOf("cookingtime")).orElse(n).forGetter(AbstractCookingRecipe::cookingTime)).apply((Applicative<AbstractCookingRecipe, ?>)instance, factory::create));
