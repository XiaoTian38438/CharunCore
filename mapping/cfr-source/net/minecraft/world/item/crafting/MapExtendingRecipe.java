...
extends ShapedRecipe {
    public MapExtendingRecipe(CraftingBookCategory craftingBookCategory) {
        super("", craftingBookCategory, ShapedRecipePattern.of(Map.of(Character.valueOf('#'), Ingredient.of((ItemLike)Items.PAPER), Character.valueOf('x'), Ingredient.of((ItemLike)Items.FILLED_MAP)), "###", "#x#", "###"), new ItemStack(Items.MAP));
    }
