...
implements SmithingRecipe {
    ...
    implements RecipeSerializer<SmithingTransformRecipe> {
        private static final MapCodec<SmithingTransformRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Ingredient.CODEC.optionalFieldOf("template").forGetter(smithingTransformRecipe -> smithingTransformRecipe.template), ((MapCodec)Ingredient.CODEC.fieldOf("base")).forGetter(smithingTransformRecipe -> smithingTransformRecipe.base), Ingredient.CODEC.optionalFieldOf("addition").forGetter(smithingTransformRecipe -> smithingTransformRecipe.addition), ((MapCodec)TransmuteResult.CODEC.fieldOf("result")).forGetter(smithingTransformRecipe -> smithingTransformRecipe.result)).apply((Applicative<SmithingTransformRecipe, ?>)instance, SmithingTransformRecipe::new));
