...
implements Recipe<SingleRecipeInput> {
    ...
    implements RecipeSerializer<T> {
        private final MapCodec<T> codec = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.STRING.optionalFieldOf("group", "").forGetter(SingleItemRecipe::group), ((MapCodec)Ingredient.CODEC.fieldOf("ingredient")).forGetter(SingleItemRecipe::input), ((MapCodec)ItemStack.STRICT_CODEC.fieldOf("result")).forGetter(SingleItemRecipe::result)).apply((Applicative<SingleItemRecipe, ?>)instance, factory::create));
