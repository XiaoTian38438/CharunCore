...
public record Instrument(Holder<SoundEvent> soundEvent, float useDuration, float range, Component description) {
    public static final Codec<Instrument> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)SoundEvent.CODEC.fieldOf("sound_event")).forGetter(Instrument::soundEvent), ((MapCodec)ExtraCodecs.POSITIVE_FLOAT.fieldOf("use_duration")).forGetter(Instrument::useDuration), ((MapCodec)ExtraCodecs.POSITIVE_FLOAT.fieldOf("range")).forGetter(Instrument::range), ((MapCodec)ComponentSerialization.CODEC.fieldOf("description")).forGetter(Instrument::description)).apply((Applicative<Instrument, ?>)instance, Instrument::new));
