...
{
    public static final MapCodec<RemoveStatusEffectsConsumeEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)RegistryCodecs.homogeneousList(Registries.MOB_EFFECT).fieldOf("effects")).forGetter(RemoveStatusEffectsConsumeEffect::effects)).apply((Applicative<RemoveStatusEffectsConsumeEffect, ?>)instance, RemoveStatusEffectsConsumeEffect::new));
