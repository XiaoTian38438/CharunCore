...
public record TeleportRandomlyConsumeEffect(float diameter) implements ConsumeEffect
{
    ...
    public static final MapCodec<TeleportRandomlyConsumeEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(ExtraCodecs.POSITIVE_FLOAT.optionalFieldOf("diameter", Float.valueOf(16.0f)).forGetter(TeleportRandomlyConsumeEffect::diameter)).apply((Applicative<TeleportRandomlyConsumeEffect, ?>)instance, TeleportRandomlyConsumeEffect::new));
