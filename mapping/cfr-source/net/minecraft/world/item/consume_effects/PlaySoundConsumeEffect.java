...
{
    public static final MapCodec<PlaySoundConsumeEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)SoundEvent.CODEC.fieldOf("sound")).forGetter(PlaySoundConsumeEffect::sound)).apply((Applicative<PlaySoundConsumeEffect, ?>)instance, PlaySoundConsumeEffect::new));
