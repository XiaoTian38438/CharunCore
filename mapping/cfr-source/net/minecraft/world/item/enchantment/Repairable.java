...
public record Repairable(HolderSet<Item> items) {
    public static final Codec<Repairable> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)RegistryCodecs.homogeneousList(Registries.ITEM).fieldOf("items")).forGetter(Repairable::items)).apply((Applicative<Repairable, ?>)instance, Repairable::new));
