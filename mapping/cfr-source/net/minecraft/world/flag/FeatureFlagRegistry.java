...
public class FeatureFlagRegistry {
    ...
    public Codec<FeatureFlagSet> codec() {
        return Identifier.CODEC.listOf().comapFlatMap(list -> {
            ...
            FeatureFlagSet featureFlagSet = this.fromNames((Iterable<Identifier>)list, hashSet::add);
            if (!hashSet.isEmpty()) {
                return DataResult.error(() -> "Unknown feature ids: " + String.valueOf(hashSet), featureFlagSet);
            }
