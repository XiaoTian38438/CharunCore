...
extends AbstractMountInventoryMenu {
    ...
    public NautilusInventoryMenu(int n, Inventory inventory, Container container, final AbstractNautilus abstractNautilus, int n2) {
        super(n, inventory, container, abstractNautilus);
