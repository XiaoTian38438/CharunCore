...
implements FeatureElement {
    ...
    private static <T extends AbstractContainerMenu> MenuType<T> register(String string, MenuSupplier<T> menuSupplier, FeatureFlag ... featureFlagArray) {
        return Registry.register(BuiltInRegistries.MENU, string, new MenuType<T>(menuSupplier, FeatureFlags.REGISTRY.subset(featureFlagArray)));
    }
