...
public class EnvironmentAttribute<Value> {
    ...
    EnvironmentAttribute(AttributeType<Value> attributeType, Value Value2, AttributeRange<Value> attributeRange, boolean bl, boolean bl2, boolean bl3) {
    ...
    public Value sanitizeValue(Value Value2) {
        return this.valueRange.sanitize(Value2);
    }
    ...
    public static class Builder<Value> {
        ...
        public Builder<Value> defaultValue(Value Value2) {
            this.defaultValue = Value2;
            return this;
        }
