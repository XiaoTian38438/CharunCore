...
public record AmbientParticle(ParticleOptions particle, float probability) {
    public static final Codec<AmbientParticle> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)ParticleTypes.CODEC.fieldOf("particle")).forGetter(ambientParticle -> ambientParticle.particle), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("probability")).forGetter(ambientParticle -> Float.valueOf(ambientParticle.probability))).apply((Applicative<AmbientParticle, ?>)instance, AmbientParticle::new));
