...
implements EnvironmentAttributeReader {
    ...
    private <Value> ValueSampler<Value> bakeLayerSampler(EnvironmentAttribute<Value> environmentAttribute, List<? extends EnvironmentAttributeLayer<?>> list) {
        ...
        Value Value2 = environmentAttribute.defaultValue();
        while (!arrayList.isEmpty() && (e = arrayList.getFirst()) instanceof EnvironmentAttributeLayer.Constant) {
            EnvironmentAttributeLayer.Constant constant = (EnvironmentAttributeLayer.Constant)e;
            Value2 = constant.applyConstant(Value2);
            arrayList.removeFirst();
        }
        boolean bl = arrayList.stream().anyMatch(environmentAttributeLayer -> environmentAttributeLayer instanceof EnvironmentAttributeLayer.Positional);
        return new ValueSampler<Value>(environmentAttribute, Value2, List.copyOf(arrayList), bl);
    }
    ...
    static class ValueSampler<Value> {
        ...
        ValueSampler(EnvironmentAttribute<Value> environmentAttribute, Value Value2, List<EnvironmentAttributeLayer<Value>> list, boolean bl) {
            this.attribute = environmentAttribute;
            this.baseValue = Value2;
            this.layers = list;
        ...
        public Value getDimensionValue() {
            ...
            Value Value2 = this.computeValueNotPositional();
            this.cachedTickValue = Value2;
            return Value2;
        }
        ...
        private Value computeValuePositional(Vec3 vec3, @Nullable SpatialAttributeInterpolator spatialAttributeInterpolator) {
            ...
            for (EnvironmentAttributeLayer<Value> environmentAttributeLayer : this.layers) {
                ...
                int n = 0;
                Value2 = switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{EnvironmentAttributeLayer.Constant.class, EnvironmentAttributeLayer.TimeBased.class, EnvironmentAttributeLayer.Positional.class}, environmentAttributeLayer2, n)) {
                    default -> throw new MatchException(null, null);
                    case 0 -> {
                        EnvironmentAttributeLayer.Constant var8_8 = (EnvironmentAttributeLayer.Constant)environmentAttributeLayer2;
                        yield var8_8.applyConstant(Value2);
                    }
                    case 1 -> {
                        EnvironmentAttributeLayer.TimeBased var9_9 = (EnvironmentAttributeLayer.TimeBased)environmentAttributeLayer2;
                        yield var9_9.applyTimeBased(Value2, this.cacheTickId);
                    }
                    case 2 -> {
                        EnvironmentAttributeLayer.Positional var10_10 = (EnvironmentAttributeLayer.Positional)environmentAttributeLayer2;
                        yield var10_10.applyPositional(Value2, Objects.requireNonNull(vec3), spatialAttributeInterpolator);
                    }
                };
            }
        ...
        private Value computeValueNotPositional() {
            ...
            for (EnvironmentAttributeLayer<Value> environmentAttributeLayer : this.layers) {
                ...
                Value2 = switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{EnvironmentAttributeLayer.Constant.class, EnvironmentAttributeLayer.TimeBased.class, EnvironmentAttributeLayer.Positional.class}, environmentAttributeLayer2, n)) {
                    default -> throw new MatchException(null, null);
                    case 0 -> {
                        EnvironmentAttributeLayer.Constant var6_6 = (EnvironmentAttributeLayer.Constant)environmentAttributeLayer2;
                        yield var6_6.applyConstant(Value2);
                    }
                    case 1 -> {
                        EnvironmentAttributeLayer.TimeBased var7_7 = (EnvironmentAttributeLayer.TimeBased)environmentAttributeLayer2;
                        yield var7_7.applyTimeBased(Value2, this.cacheTickId);
                    }
                    case 2 -> {
                        EnvironmentAttributeLayer.Positional var8_8 = (EnvironmentAttributeLayer.Positional)environmentAttributeLayer2;
                        yield Value2;
                    }
                };
            }
