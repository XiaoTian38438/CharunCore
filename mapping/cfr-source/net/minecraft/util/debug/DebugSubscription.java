...
public class DebugSubscription<T> {
    ...
    public DebugSubscription(@Nullable StreamCodec<? super RegistryFriendlyByteBuf, T> streamCodec, int n) {
        this.valueStreamCodec = streamCodec;
        this.expireAfterTicks = n;
    }
    ...
    public Update<T> packUpdate(@Nullable T t) {
        return new Update<T>(this, Optional.ofNullable(t));
    }
    ...
    public Event<T> packEvent(T t) {
        return new Event<T>(this, t);
    }
