...
public class DebugSubscriptions<T> {
    ...
    private static <T> DebugSubscription<T> registerTemporaryValue(String string, StreamCodec<? super RegistryFriendlyByteBuf, T> streamCodec, int n) {
        return Registry.register(BuiltInRegistries.DEBUG_SUBSCRIPTION, Identifier.withDefaultNamespace(string), new DebugSubscription<T>(streamCodec, n));
    }
}
