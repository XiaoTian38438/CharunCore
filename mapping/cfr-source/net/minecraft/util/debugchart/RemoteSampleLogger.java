...
extends AbstractSampleLogger {
    ...
    public RemoteSampleLogger(int n, ServerDebugSubscribers serverDebugSubscribers, RemoteDebugSampleType remoteDebugSampleType) {
        this(n, serverDebugSubscribers, remoteDebugSampleType, new long[n]);
    }

    public RemoteSampleLogger(int n, ServerDebugSubscribers serverDebugSubscribers, RemoteDebugSampleType remoteDebugSampleType, long[] lArray) {
        super(n, lArray);
