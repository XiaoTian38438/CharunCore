...
public interface ProfilerFiller {
    ...
    default public void setZoneColor(int n) {
    }
    ...
    implements ProfilerFiller {
        ...
        public void incrementCounter(String string, int n) {
            this.first.incrementCounter(string, n);
            this.second.incrementCounter(string, n);
        }

        @Override
        public void incrementCounter(Supplier<String> supplier, int n) {
            this.first.incrementCounter(supplier, n);
            this.second.incrementCounter(supplier, n);
        }
        ...
        public void setZoneColor(int n) {
            this.first.setZoneColor(n);
            this.second.setZoneColor(n);
        }
    }
}
