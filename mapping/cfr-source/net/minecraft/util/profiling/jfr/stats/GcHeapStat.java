...
public record GcHeapStat(Instant timestamp, long heapUsed, Timing timing) {
    ...
    public static Summary summary(Duration duration, List<GcHeapStat> list, Duration duration2, int n) {
        return new Summary(duration, duration2, n, GcHeapStat.calculateAllocationRatePerSecond(list));
    }
    ...
    private static double calculateAllocationRatePerSecond(List<GcHeapStat> list) {
        ...
        for (int i = 1; i < list2.size(); ++i) {
            ...
            GcHeapStat gcHeapStat3 = list3.get(i - 1);
            l += gcHeapStat2.heapUsed - gcHeapStat3.heapUsed;
        }
