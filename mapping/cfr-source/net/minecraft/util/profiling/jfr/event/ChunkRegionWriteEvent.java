...
extends ChunkRegionIoEvent {
    ...
    public ChunkRegionWriteEvent(RegionStorageInfo regionStorageInfo, ChunkPos chunkPos, RegionFileVersion regionFileVersion, int n) {
        super(regionStorageInfo, chunkPos, regionFileVersion, n);
    }
}
