...
public enum TriState implements StringRepresentable
{
    ...
    static {
        CODEC = Codec.either(Codec.BOOL, StringRepresentable.fromEnum(TriState::values)).xmap(either -> either.map(TriState::from, Function.identity()), triState -> switch (triState.ordinal()) {
