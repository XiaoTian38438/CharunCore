...
extends DataFix {
                ...
                if ("minecraft:noise".equals(string)) {
                    ...
                    dynamic2 = dynamic2.update("biome_source", dynamic -> {
                        ...
                        if ("minecraft:vanilla_layered".equals(string) || bl && "minecraft:multi_noise".equals(string)) {
                            ...
                            return dynamic.createMap((Map<? extends Dynamic<?>, ? extends Dynamic<?>>)ImmutableMap.of(dynamic.createString("preset"), dynamic.createString("minecraft:overworld"), dynamic.createString("type"), dynamic.createString("minecraft:multi_noise")));
                        }
                        return dynamic;
                    });
    ...
    private static Dynamic<?> updateLayers(Dynamic<?> dynamic) {
        Dynamic dynamic2 = dynamic.createMap((Map<Dynamic<?>, Dynamic<?>>)ImmutableMap.of(dynamic.createString("height"), dynamic.createInt(64), dynamic.createString("block"), dynamic.createString("minecraft:air")));
