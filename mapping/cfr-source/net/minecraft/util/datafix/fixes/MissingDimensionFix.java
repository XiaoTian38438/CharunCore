...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        Type<Pair<String, ?>> type = DSL.taggedChoiceType("type", DSL.string(), ImmutableMap.of((Object)"minecraft:debug", DSL.remainderType(), (Object)"minecraft:flat", MissingDimensionFix.flatType(schema), (Object)"minecraft:noise", MissingDimensionFix.optionalFields("biome_source", DSL.taggedChoiceType("type", DSL.string(), ImmutableMap.of((Object)"minecraft:fixed", MissingDimensionFix.fields("biome", schema.getType(References.BIOME)), (Object)"minecraft:multi_noise", DSL.list(MissingDimensionFix.fields("biome", schema.getType(References.BIOME))), (Object)"minecraft:checkerboard", MissingDimensionFix.fields("biomes", DSL.list(schema.getType(References.BIOME))), (Object)"minecraft:vanilla_layered", DSL.remainderType(), (Object)"minecraft:the_end", DSL.remainderType())), "settings", DSL.or(DSL.string(), MissingDimensionFix.optionalFields("default_block", schema.getType(References.BLOCK_NAME), "default_fluid", schema.getType(References.BLOCK_NAME))))));
        CompoundList.CompoundListType<String, Pair<Pair<String, ?>, Dynamic<?>>> compoundListType = DSL.compoundList(NamespacedSchema.namespacedString(), MissingDimensionFix.fields("generator", type));
        ...
        return this.fixTypeEverywhereTyped("MissingDimensionFix", type3, typed -> typed.updateTyped(fieldFinder, typed3 -> typed3.updateTyped(opticFinder, typed2 -> {
