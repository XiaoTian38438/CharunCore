...
extends NamedEntityFix {
    ...
    public Dynamic<?> fixTag(Dynamic<Tag> dynamic) {
        ...
        Identifier identifier = VanillaTrialChambers.CONFIGS_TO_KEY.get(Pair.of(optional.get(), optional2.get()));
        if (identifier == null) {
            return dynamic;
        }
    ...
    static final class VanillaTrialChambers {
        ...
        private static void register(Identifier identifier, String string, String string2) {
            try {
                ...
                CONFIGS_TO_KEY.put(Pair.of(dynamic, VanillaTrialChambers.asDynamic(compoundTag2)), identifier);
                CONFIGS_TO_KEY.put(Pair.of(dynamic, VanillaTrialChambers.asDynamic(compoundTag3)), identifier);
                CONFIGS_TO_KEY.put(Pair.of(dynamic, VanillaTrialChambers.asDynamic(compoundTag4)), identifier);
            }
        ...
        private static Dynamic<Tag> asDynamic(CompoundTag compoundTag) {
            return new Dynamic<Tag>(NbtOps.INSTANCE, compoundTag);
        }
