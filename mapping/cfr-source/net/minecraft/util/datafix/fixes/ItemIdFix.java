...
extends DataFix {
    private static final Int2ObjectMap<String> ITEM_NAMES = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), (Typed<?> typed) -> typed.update(opticFinder, type2, either -> either.map(n -> Pair.of(References.ITEM_NAME.typeName(), ItemIdFix.getItem(n)), pair -> pair)));
    }
}
