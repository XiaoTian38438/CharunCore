    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemShulkerBoxColorFix", type, typed -> {
            ...
            if (optional3.isPresent() && Objects.equals(((Pair)optional3.get()).getSecond(), "minecraft:shulker_box") && (optional2 = typed.getOptionalTyped(opticFinder2)).isPresent() && (optional = (typed2 = optional2.get()).getOptionalTyped(opticFinder3)).isPresent()) {
                ...
                return typed.set(opticFinder2, typed2.set(opticFinder3, typed3.set(DSL.remainderFinder(), dynamic))).set(opticFinder, Pair.of(References.ITEM_NAME.typeName(), NAMES_BY_COLOR[n % 16]));
            }
            return typed;
        });
    }
