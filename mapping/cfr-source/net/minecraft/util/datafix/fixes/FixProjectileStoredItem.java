...
extends DataFix {
    ...
    private static Dynamic<?> createItemStack(Dynamic<?> dynamic, String string) {
        return dynamic.createMap((Map<Dynamic<?>, Dynamic<?>>)ImmutableMap.of(dynamic.createString("id"), dynamic.createString(string), dynamic.createString("Count"), dynamic.createInt(1)));
    }
