...
extends Schema {
    ...
    protected static final Hook.HookFunction ADD_NAMES = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> dynamicOps, T t) {
            return V99.addNames(new Dynamic<T>(dynamicOps, t), ITEM_TO_BLOCKENTITY, V99.ITEM_TO_ENTITY);
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        BlockEntityIdFix.ID_MAP.forEach((string, string2) -> map.put((String)string2, Objects.requireNonNull((Supplier)map.remove(string), () -> "Didn't find " + string + " in schema")));
        return map;
    }
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> map, Map<String, Supplier<TypeTemplate>> map2) {
        ...
        schema.registerType(true, References.BLOCK_ENTITY, () -> DSL.optionalFields("components", References.DATA_COMPONENTS.in(schema), DSL.taggedChoiceLazy("id", NamespacedSchema.namespacedString(), map2)));
