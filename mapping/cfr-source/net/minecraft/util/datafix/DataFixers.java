...
public class DataFixers {
    ...
    public static CompletableFuture<?> optimize(Set<DSL.TypeReference> set) {
        ...
        return DATA_FIXER.optimize(set, executorService);
    }
    ...
    private static void addFixers(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(new NamedEntityWriteReadFix(schema58, true, "Command block block entity custom name fix", References.BLOCK_ENTITY, "minecraft:command_block"){
        ...
        dataFixerBuilder.addFixer(new DataFix(schema58, false){
            ...
            protected TypeRewriteRule makeRule() {
                ...
                OpticFinder<?> opticFinder3 = DSL.typeFinder(this.getInputSchema().getType(References.TEXT_COMPONENT));
        ...
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema65, "Recipes fix", References.RECIPE, DataFixers.createRenamer(RecipesFix.RECIPES)));
        ...
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema67, "Recipes renamening fix", References.RECIPE, DataFixers.createRenamer(RecipesRenameningFix.RECIPES)));
        dataFixerBuilder.addFixer(new EntityTheRenameningFix(schema67, true));
        dataFixerBuilder.addFixer(new StatsRenameFix(schema67, "SwimStatsRenameFix", (Map<String, String>)ImmutableMap.of((Object)"minecraft:swim_one_cm", (Object)"minecraft:walk_on_water_one_cm", (Object)"minecraft:dive_one_cm", (Object)"minecraft:walk_under_water_one_cm")));
        ...
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema95, "Rename sugar recipe", References.RECIPE, DataFixers.createRenamer("minecraft:sugar", "minecraft:sugar_from_sugar_cane")));
        ...
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema124, "Nether biome rename", References.BIOME, DataFixers.createRenamer("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema125 = dataFixerBuilder.addSchema(2553, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema125, "Biomes fix", References.BIOME, DataFixers.createRenamer(BiomeFix.BIOMES)));
        Schema schema126 = dataFixerBuilder.addSchema(2556, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OptionsFancyGraphicsToGraphicsModeFix(schema126));
        Schema schema127 = dataFixerBuilder.addSchema(2558, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new MissingDimensionFix(schema127, false));
        dataFixerBuilder.addFixer(new OptionsRenameFieldFix(schema127, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
        Schema schema128 = dataFixerBuilder.addSchema(2568, V2568::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema128, "Added Piglin Brute", References.ENTITY));
        Schema schema129 = dataFixerBuilder.addSchema(2571, V2571::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema129, "Added Goat", References.ENTITY));
        Schema schema130 = dataFixerBuilder.addSchema(2679, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new CauldronRenameFix(schema130, false));
        ...
        dataFixerBuilder.addFixer(new AddNewChoices(schema132, "Added Sculk Sensor", References.BLOCK_ENTITY));
        Schema schema133 = dataFixerBuilder.addSchema(2686, V2686::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema133, "Added Axolotl", References.ENTITY));
        Schema schema134 = dataFixerBuilder.addSchema(2688, V2688::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema134, "Added Glow Squid", References.ENTITY));
        dataFixerBuilder.addFixer(new AddNewChoices(schema134, "Added Glow Item Frame", References.ENTITY));
        ...
        dataFixerBuilder.addFixer(new AddFlagIfNotPresentFix(schema137, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
        ...
        dataFixerBuilder.addFixer(new SavedDataFeaturePoolElementFix(schema140));
        Schema schema141 = dataFixerBuilder.addSchema(2702, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AbstractArrowPickupFix(schema141));
        Schema schema142 = dataFixerBuilder.addSchema(2704, V2704::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema142, "Added Goat", References.ENTITY));
        Schema schema143 = dataFixerBuilder.addSchema(2707, V2707::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema143, "Added Marker", References.ENTITY));
        dataFixerBuilder.addFixer(new AddFlagIfNotPresentFix(schema143, References.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
        Schema schema144 = dataFixerBuilder.addSchema(2710, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new StatsRenameFix(schema144, "Renamed play_one_minute stat to play_time", (Map<String, String>)ImmutableMap.of((Object)"minecraft:play_one_minute", (Object)"minecraft:play_time")));
        ...
        dataFixerBuilder.addFixer(new AddFlagIfNotPresentFix(schema146, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
        Schema schema147 = dataFixerBuilder.addSchema(2831, V2831::new);
        dataFixerBuilder.addFixer(new SpawnerDataFix(schema147));
        Schema schema148 = dataFixerBuilder.addSchema(2832, V2832::new);
        dataFixerBuilder.addFixer(new WorldGenSettingsHeightAndBiomeFix(schema148));
        dataFixerBuilder.addFixer(new ChunkHeightAndBiomeFix(schema148));
        Schema schema149 = dataFixerBuilder.addSchema(2833, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema149));
        Schema schema150 = dataFixerBuilder.addSchema(2838, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema150, "Caves and Cliffs biome renames", References.BIOME, DataFixers.createRenamer(CavesAndCliffsRenames.RENAMES)));
        Schema schema151 = dataFixerBuilder.addSchema(2841, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ChunkProtoTickListFix(schema151));
        Schema schema152 = dataFixerBuilder.addSchema(2842, V2842::new);
        dataFixerBuilder.addFixer(new ChunkRenamesFix(schema152));
        Schema schema153 = dataFixerBuilder.addSchema(2843, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OverreachingTickFix(schema153));
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema153, "Remove Deep Warm Ocean", References.BIOME, DataFixers.createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        Schema schema154 = dataFixerBuilder.addSchema(2846, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AdvancementsRenameFix(schema154, false, "Rename some C&C part 2 advancements", DataFixers.createRenamer((Map<String, String>)ImmutableMap.of((Object)"minecraft:husbandry/play_jukebox_in_meadows", (Object)"minecraft:adventure/play_jukebox_in_meadows", (Object)"minecraft:adventure/caves_and_cliff", (Object)"minecraft:adventure/fall_from_world_height", (Object)"minecraft:adventure/ride_strider_in_overworld_lava", (Object)"minecraft:nether/ride_strider_in_overworld_lava"))));
        Schema schema155 = dataFixerBuilder.addSchema(2852, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema155));
        Schema schema156 = dataFixerBuilder.addSchema(2967, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new StructureSettingsFlattenFix(schema156));
        Schema schema157 = dataFixerBuilder.addSchema(2970, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new StructuresBecomeConfiguredFix(schema157));
        Schema schema158 = dataFixerBuilder.addSchema(3076, V3076::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema158, "Added Sculk Catalyst", References.BLOCK_ENTITY));
        Schema schema159 = dataFixerBuilder.addSchema(3077, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ChunkDeleteIgnoredLightDataFix(schema159));
        Schema schema160 = dataFixerBuilder.addSchema(3078, V3078::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema160, "Added Frog", References.ENTITY));
        dataFixerBuilder.addFixer(new AddNewChoices(schema160, "Added Tadpole", References.ENTITY));
        dataFixerBuilder.addFixer(new AddNewChoices(schema160, "Added Sculk Shrieker", References.BLOCK_ENTITY));
        Schema schema161 = dataFixerBuilder.addSchema(3081, V3081::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema161, "Added Warden", References.ENTITY));
        Schema schema162 = dataFixerBuilder.addSchema(3082, V3082::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema162, "Added Chest Boat", References.ENTITY));
        Schema schema163 = dataFixerBuilder.addSchema(3083, V3083::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema163, "Added Allay", References.ENTITY));
        ...
        dataFixerBuilder.addFixer(new EntityVariantFix(schema165, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", arg_0 -> ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
        ...
        dataFixerBuilder.addFixer(new CriteriaRenameFix(schema165, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", string -> (String)immutableMap4.getOrDefault(string, string)));
        Schema schema166 = dataFixerBuilder.addSchema(3087, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntityVariantFix(schema166, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", arg_0 -> ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
        ...
        dataFixerBuilder.addFixer(new EntityFieldsRenameFix(schema167, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
        Schema schema168 = dataFixerBuilder.addSchema(3093, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntityGoatMissingStateFix(schema168));
        Schema schema169 = dataFixerBuilder.addSchema(3094, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new GoatHornIdFix(schema169));
        Schema schema170 = dataFixerBuilder.addSchema(3097, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new FilteredBooksFix(schema170));
        dataFixerBuilder.addFixer(new FilteredSignsFix(schema170));
        Map<String, String> map = Map.of("minecraft:british", "minecraft:british_shorthair");
        dataFixerBuilder.addFixer(new VariantRenameFix(schema170, "Rename british shorthair", References.ENTITY, "minecraft:cat", map));
        dataFixerBuilder.addFixer(new CriteriaRenameFix(schema170, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", string -> map.getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer(new PoiTypeRemoveFix(schema170, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
        Schema schema171 = dataFixerBuilder.addSchema(3108, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new BlendingDataRemoveFromNetherEndFix(schema171));
        Schema schema172 = dataFixerBuilder.addSchema(3201, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OptionsProgrammerArtFix(schema172));
        Schema schema173 = dataFixerBuilder.addSchema(3202, V3202::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema173, "Added Hanging Sign", References.BLOCK_ENTITY));
        Schema schema174 = dataFixerBuilder.addSchema(3203, V3203::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema174, "Added Camel", References.ENTITY));
        Schema schema175 = dataFixerBuilder.addSchema(3204, V3204::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema175, "Added Chiseled Bookshelf", References.BLOCK_ENTITY));
        Schema schema176 = dataFixerBuilder.addSchema(3209, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ItemStackSpawnEggFix(schema176, false, "minecraft:pig_spawn_egg"));
        Schema schema177 = dataFixerBuilder.addSchema(3214, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OptionsAmbientOcclusionFix(schema177));
        Schema schema178 = dataFixerBuilder.addSchema(3319, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OptionsAccessibilityOnboardFix(schema178));
        Schema schema179 = dataFixerBuilder.addSchema(3322, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EffectDurationFix(schema179));
        Schema schema180 = dataFixerBuilder.addSchema(3325, V3325::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema180, "Added displays", References.ENTITY));
        Schema schema181 = dataFixerBuilder.addSchema(3326, V3326::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema181, "Added Sniffer", References.ENTITY));
        Schema schema182 = dataFixerBuilder.addSchema(3327, V3327::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema182, "Archaeology", References.BLOCK_ENTITY));
        Schema schema183 = dataFixerBuilder.addSchema(3328, V3328::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema183, "Added interaction", References.ENTITY));
        ...
        dataFixerBuilder.addFixer(new EntityBrushableBlockFieldsRenameFix(schema184));
        ...
        dataFixerBuilder.addFixer(new AddNewChoices(schema184, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
        Schema schema185 = dataFixerBuilder.addSchema(3439, V3439::new);
        dataFixerBuilder.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema185, "Updated sign text format for Signs", "minecraft:sign"));
        Schema schema186 = dataFixerBuilder.addSchema(3439, 1, V3439_1::new);
        dataFixerBuilder.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema186, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
        Schema schema187 = dataFixerBuilder.addSchema(3440, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema187, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, DataFixers.createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
        dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema187, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
        ...
        dataFixerBuilder.addFixer(new DecoratedPotFieldRenameFix(schema189));
        Schema schema190 = dataFixerBuilder.addSchema(3450, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new RemapChunkStatusFix(schema190, "Remove liquid_carvers and heightmap chunk statuses", DataFixers.createRenamer(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
        Schema schema191 = dataFixerBuilder.addSchema(3451, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ChunkDeleteLightFix(schema191));
        Schema schema192 = dataFixerBuilder.addSchema(3459, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new LegacyDragonFightFix(schema192));
        Schema schema193 = dataFixerBuilder.addSchema(3564, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new DropInvalidSignDataFix(schema193, "minecraft:sign"));
        Schema schema194 = dataFixerBuilder.addSchema(3564, 1, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new DropInvalidSignDataFix(schema194, "minecraft:hanging_sign"));
        Schema schema195 = dataFixerBuilder.addSchema(3565, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new RandomSequenceSettingsFix(schema195));
        Schema schema196 = dataFixerBuilder.addSchema(3566, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ScoreboardDisplaySlotFix(schema196));
        Schema schema197 = dataFixerBuilder.addSchema(3568, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new MobEffectIdFix(schema197));
        Schema schema198 = dataFixerBuilder.addSchema(3682, V3682::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema198, "Added Crafter", References.BLOCK_ENTITY));
        Schema schema199 = dataFixerBuilder.addSchema(3683, V3683::new);
        dataFixerBuilder.addFixer(new PrimedTntBlockStateFixer(schema199));
        Schema schema200 = dataFixerBuilder.addSchema(3685, V3685::new);
        dataFixerBuilder.addFixer(new FixProjectileStoredItem(schema200));
        Schema schema201 = dataFixerBuilder.addSchema(3689, V3689::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema201, "Added Breeze", References.ENTITY));
        dataFixerBuilder.addFixer(new AddNewChoices(schema201, "Added Trial Spawner", References.BLOCK_ENTITY));
        ...
        dataFixerBuilder.addFixer(new AddNewChoices(schema203, "Added Armadillo", References.ENTITY));
        ...
        dataFixerBuilder.addFixer(new RenameEnchantmentsFix(schema205, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
        Schema schema206 = dataFixerBuilder.addSchema(3807, V3807::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema206, "Added Vault", References.BLOCK_ENTITY));
        Schema schema207 = dataFixerBuilder.addSchema(3807, 1, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new MapBannerBlockPosFormatFix(schema207));
        Schema schema208 = dataFixerBuilder.addSchema(3808, V3808::new);
        dataFixerBuilder.addFixer(new HorseBodyArmorItemFix(schema208, "minecraft:horse", "ArmorItem", true));
        Schema schema209 = dataFixerBuilder.addSchema(3808, 1, V3808_1::new);
        dataFixerBuilder.addFixer(new HorseBodyArmorItemFix(schema209, "minecraft:llama", "DecorItem", false));
        Schema schema210 = dataFixerBuilder.addSchema(3808, 2, V3808_2::new);
        dataFixerBuilder.addFixer(new HorseBodyArmorItemFix(schema210, "minecraft:trader_llama", "DecorItem", false));
        Schema schema211 = dataFixerBuilder.addSchema(3809, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ChestedHorsesInventoryZeroIndexingFix(schema211));
        Schema schema212 = dataFixerBuilder.addSchema(3812, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new FixWolfHealth(schema212));
        Schema schema213 = dataFixerBuilder.addSchema(3813, V3813::new);
        dataFixerBuilder.addFixer(new BlockPosFormatAndRenamesFix(schema213));
        Schema schema214 = dataFixerBuilder.addSchema(3814, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AttributesRenameLegacy(schema214, "Rename jump strength attribute", DataFixers.createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        Schema schema215 = dataFixerBuilder.addSchema(3816, V3816::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema215, "Added Bogged", References.ENTITY));
        Schema schema216 = dataFixerBuilder.addSchema(3818, V3818::new);
        dataFixerBuilder.addFixer(new BeehiveFieldRenameFix(schema216));
        dataFixerBuilder.addFixer(new EmptyItemInHotbarFix(schema216));
        Schema schema217 = dataFixerBuilder.addSchema(3818, 1, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new BannerPatternFormatFix(schema217));
        Schema schema218 = dataFixerBuilder.addSchema(3818, 2, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new TippedArrowPotionToItemFix(schema218));
        Schema schema219 = dataFixerBuilder.addSchema(3818, 3, V3818_3::new);
        dataFixerBuilder.addFixer(new WriteAndReadFix(schema219, "Inject data component types", References.DATA_COMPONENTS));
        Schema schema220 = dataFixerBuilder.addSchema(3818, 4, V3818_4::new);
        dataFixerBuilder.addFixer(new ParticleUnflatteningFix(schema220));
        Schema schema221 = dataFixerBuilder.addSchema(3818, 5, V3818_5::new);
        dataFixerBuilder.addFixer(new ItemStackComponentizationFix(schema221));
        Schema schema222 = dataFixerBuilder.addSchema(3818, 6, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AreaEffectCloudPotionFix(schema222));
        Schema schema223 = dataFixerBuilder.addSchema(3820, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new PlayerHeadBlockProfileFix(schema223));
        dataFixerBuilder.addFixer(new LodestoneCompassComponentFix(schema223));
        Schema schema224 = dataFixerBuilder.addSchema(3825, V3825::new);
        dataFixerBuilder.addFixer(new ItemStackCustomNameToOverrideComponentFix(schema224));
        dataFixerBuilder.addFixer(new BannerEntityCustomNameToOverrideComponentFix(schema224));
        dataFixerBuilder.addFixer(new TrialSpawnerConfigFix(schema224));
        dataFixerBuilder.addFixer(new AddNewChoices(schema224, "Added Ominous Item Spawner", References.ENTITY));
        Schema schema225 = dataFixerBuilder.addSchema(3828, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EmptyItemInVillagerTradeFix(schema225));
        Schema schema226 = dataFixerBuilder.addSchema(3833, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new RemoveEmptyItemInBrushableBlockFix(schema226));
        Schema schema227 = dataFixerBuilder.addSchema(3938, V3938::new);
        dataFixerBuilder.addFixer(new ProjectileStoredWeaponFix(schema227));
        Schema schema228 = dataFixerBuilder.addSchema(3939, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema228, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
        Schema schema229 = dataFixerBuilder.addSchema(3943, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OptionsMenuBlurrinessFix(schema229));
        Schema schema230 = dataFixerBuilder.addSchema(3945, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AttributeModifierIdFix(schema230));
        dataFixerBuilder.addFixer(new JukeboxTicksSinceSongStartedFix(schema230));
        Schema schema231 = dataFixerBuilder.addSchema(4054, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OminousBannerRarityFix(schema231));
        Schema schema232 = dataFixerBuilder.addSchema(4055, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AttributeIdPrefixFix(schema232));
        Schema schema233 = dataFixerBuilder.addSchema(4057, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new CarvingStepRemoveFix(schema233));
        Schema schema234 = dataFixerBuilder.addSchema(4059, V4059::new);
        dataFixerBuilder.addFixer(new FoodToConsumableFix(schema234));
        Schema schema235 = dataFixerBuilder.addSchema(4061, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new TrialSpawnerConfigInRegistryFix(schema235));
        Schema schema236 = dataFixerBuilder.addSchema(4064, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new FireResistantToDamageResistantComponentFix(schema236));
        Schema schema237 = dataFixerBuilder.addSchema(4067, V4067::new);
        dataFixerBuilder.addFixer(new BoatSplitFix(schema237));
        dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema237, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
        Schema schema238 = dataFixerBuilder.addSchema(4068, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new LockComponentPredicateFix(schema238));
        dataFixerBuilder.addFixer(new ContainerBlockEntityLockPredicateFix(schema238));
        Schema schema239 = dataFixerBuilder.addSchema(4070, V4070::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema239, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
        Schema schema240 = dataFixerBuilder.addSchema(4071, V4071::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema240, "Added Creaking", References.ENTITY));
        dataFixerBuilder.addFixer(new AddNewChoices(schema240, "Added Creaking Heart", References.BLOCK_ENTITY));
        Schema schema241 = dataFixerBuilder.addSchema(4081, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntitySalmonSizeFix(schema241));
        Schema schema242 = dataFixerBuilder.addSchema(4173, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntityFieldsRenameFix(schema242, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
        Schema schema243 = dataFixerBuilder.addSchema(4175, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EquippableAssetRenameFix(schema243));
        dataFixerBuilder.addFixer(new CustomModelDataExpandFix(schema243));
        Schema schema244 = dataFixerBuilder.addSchema(4176, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new InvalidBlockEntityLockFix(schema244));
        dataFixerBuilder.addFixer(new InvalidLockComponentFix(schema244));
        Schema schema245 = dataFixerBuilder.addSchema(4180, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema245, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
        Schema schema246 = dataFixerBuilder.addSchema(4181, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema246, "minecraft:furnace"));
        dataFixerBuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema246, "minecraft:smoker"));
        dataFixerBuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema246, "minecraft:blast_furnace"));
        Schema schema247 = dataFixerBuilder.addSchema(4187, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntityAttributeBaseValueFix(schema247, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d));
        dataFixerBuilder.addFixer(new EntityAttributeBaseValueFix(schema247, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d));
        dataFixerBuilder.addFixer(new EntityAttributeBaseValueFix(schema247, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d));
        dataFixerBuilder.addFixer(new EntityAttributeBaseValueFix(schema247, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", d -> d == 40.0 ? 16.0 : d));
        dataFixerBuilder.addFixer(new EntityAttributeBaseValueFix(schema247, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", d -> d == 16.0 ? 12.0 : d));
        dataFixerBuilder.addFixer(new EntityAttributeBaseValueFix(schema247, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", d -> d == 16.0 ? 24.0 : d));
        Schema schema248 = dataFixerBuilder.addSchema(4290, V4290::new);
        dataFixerBuilder.addFixer(new UnflattenTextComponentFix(schema248));
        Schema schema249 = dataFixerBuilder.addSchema(4291, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new LegacyHoverEventFix(schema249));
        dataFixerBuilder.addFixer(new TextComponentStringifiedFlagsFix(schema249));
        Schema schema250 = dataFixerBuilder.addSchema(4292, V4292::new);
        dataFixerBuilder.addFixer(new TextComponentHoverAndClickEventFix(schema250));
        Schema schema251 = dataFixerBuilder.addSchema(4293, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new DropChancesFormatFix(schema251));
        Schema schema252 = dataFixerBuilder.addSchema(4294, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new BlockPropertyRenameAndFix(schema252, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", string -> string.equals("true") ? "awake" : "uprooted"));
        Schema schema253 = dataFixerBuilder.addSchema(4295, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new BlendingDataFix(schema253));
        Schema schema254 = dataFixerBuilder.addSchema(4296, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AreaEffectCloudDurationScaleFix(schema254));
        Schema schema255 = dataFixerBuilder.addSchema(4297, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ForcedChunkToTicketFix(schema255));
        Schema schema256 = dataFixerBuilder.addSchema(4299, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntitySpawnerItemVariantComponentFix(schema256));
        Schema schema257 = dataFixerBuilder.addSchema(4300, V4300::new);
        dataFixerBuilder.addFixer(new SaddleEquipmentSlotFix(schema257));
        Schema schema258 = dataFixerBuilder.addSchema(4301, V4301::new);
        dataFixerBuilder.addFixer(new EquipmentFormatFix(schema258));
        Schema schema259 = dataFixerBuilder.addSchema(4302, V4302::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema259, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
        Schema schema260 = dataFixerBuilder.addSchema(4303, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema260, References.ENTITY));
        dataFixerBuilder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema260, References.PLAYER));
        Schema schema261 = dataFixerBuilder.addSchema(4305, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new BlockPropertyRenameAndFix(schema261, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", string -> string));
        Schema schema262 = dataFixerBuilder.addSchema(4306, V4306::new);
        dataFixerBuilder.addFixer(new ThrownPotionSplitFix(schema262));
        Schema schema263 = dataFixerBuilder.addSchema(4307, V4307::new);
        dataFixerBuilder.addFixer(new TooltipDisplayComponentFix(schema263));
        Schema schema264 = dataFixerBuilder.addSchema(4309, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new RaidRenamesDataFix(schema264));
        dataFixerBuilder.addFixer(new ChunkTicketUnpackPosFix(schema264));
        Schema schema265 = dataFixerBuilder.addSchema(4311, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new AdvancementsRenameFix(schema265, false, "Use lodestone category change", DataFixers.createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
        Schema schema266 = dataFixerBuilder.addSchema(4312, V4312::new);
        dataFixerBuilder.addFixer(new PlayerEquipmentFix(schema266));
        Schema schema267 = dataFixerBuilder.addSchema(4314, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new InlineBlockPosFormatFix(schema267));
        Schema schema268 = dataFixerBuilder.addSchema(4420, V4420::new);
        dataFixerBuilder.addFixer(new NamedEntityConvertUncheckedFix(schema268, "AreaEffectCloudCustomParticleFix", References.ENTITY, "minecraft:area_effect_cloud"));
        Schema schema269 = dataFixerBuilder.addSchema(4421, V4421::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema269, "Added Happy Ghast", References.ENTITY));
        Schema schema270 = dataFixerBuilder.addSchema(4424, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema270, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
        dataFixerBuilder.addFixer(new AddFieldFix(schema270, References.PLAYER, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
        dataFixerBuilder.addFixer(new AddFieldFix(schema270, References.ENTITY, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
        Schema schema271 = dataFixerBuilder.addSchema(4531, V4531::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema271, "Added Copper Golem", References.ENTITY));
        Schema schema272 = dataFixerBuilder.addSchema(4532, V4532::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema272, "Added Copper Golem Statue Block Entity", References.BLOCK_ENTITY));
        Schema schema273 = dataFixerBuilder.addSchema(4533, V4533::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema273, "Added Shelf", References.BLOCK_ENTITY));
        Schema schema274 = dataFixerBuilder.addSchema(4535, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new CopperGolemWeatherStateFix(schema274));
        Schema schema275 = dataFixerBuilder.addSchema(4537, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new ChunkDeleteLightFix(schema275));
        Schema schema276 = dataFixerBuilder.addSchema(4541, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema276, "Rename chain to iron_chain", DataFixers.createRenamer("minecraft:chain", "minecraft:iron_chain")));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema276, "Rename chain to iron_chain", DataFixers.createRenamer("minecraft:chain", "minecraft:iron_chain")));
        Schema schema277 = dataFixerBuilder.addSchema(4543, V4543::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema277, "Added Mannequin", References.ENTITY));
        Schema schema278 = dataFixerBuilder.addSchema(4544, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new LegacyWorldBorderFix(schema278));
        Schema schema279 = dataFixerBuilder.addSchema(4548, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new WorldSpawnDataFix(schema279));
        dataFixerBuilder.addFixer(new PlayerRespawnDataFix(schema279));
        Schema schema280 = dataFixerBuilder.addSchema(4648, V4648::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema280, "Added Nautilus and Zombie Nautilus", References.ENTITY));
        Schema schema281 = dataFixerBuilder.addSchema(4649, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new TridentAnimationFix(schema281));
        Schema schema282 = dataFixerBuilder.addSchema(4650, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new DebugProfileOverlayReferenceFix(schema282));
        Schema schema283 = dataFixerBuilder.addSchema(4651, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OptionsGraphicsModeSplitFix(schema283, "cutoutLeaves", "false", "true", "true"));
        dataFixerBuilder.addFixer(new OptionsGraphicsModeSplitFix(schema283, "weatherRadius", "5", "10", "10"));
        dataFixerBuilder.addFixer(new OptionsGraphicsModeSplitFix(schema283, "vignette", "false", "true", "true"));
        dataFixerBuilder.addFixer(new OptionsGraphicsModeSplitFix(schema283, "improvedTransparency", "false", "false", "true"));
        dataFixerBuilder.addFixer(new OptionsSetGraphicsPresetToCustomFix(schema283));
        Schema schema284 = dataFixerBuilder.addSchema(4656, V4656::new);
        dataFixerBuilder.addFixer(new AddNewChoices(schema284, "Added Parched and Camel Husk", References.ENTITY));
        Schema schema285 = dataFixerBuilder.addSchema(4657, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new WorldBorderWarningTimeFix(schema285));
        Schema schema286 = dataFixerBuilder.addSchema(4658, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new GameRuleRegistryFix(schema286));
        Schema schema287 = dataFixerBuilder.addSchema(4661, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(new OptionsMusicToastFix(schema287, false));
    }
