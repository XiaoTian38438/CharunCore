...
public class GsonHelper {
    ...
    public static <T> @Nullable T getAsObject(JsonObject jsonObject, String string, @Nullable T t, JsonDeserializationContext jsonDeserializationContext, Class<? extends T> clazz) {
        if (jsonObject.has(string)) {
            return GsonHelper.convertToObject(jsonObject.get(string), string, jsonDeserializationContext, clazz);
        }
        return t;
