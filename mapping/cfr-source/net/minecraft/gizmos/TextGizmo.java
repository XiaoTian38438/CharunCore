...
public record TextGizmo(Vec3 pos, String text, Style style) implements Gizmo
{
    ...
    extends Record {
        ...
        public Style(int n, float f, OptionalDouble optionalDouble) {
            this.color = n;
            this.scale = f;
        ...
        public static Style forColorAndCentered(int n) {
            return new Style(n, 0.32f, OptionalDouble.empty());
        }

        public static Style forColor(int n) {
            return new Style(n, 0.32f, OptionalDouble.of(0.0));
        }
