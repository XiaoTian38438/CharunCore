...
implements GizmoCollector {
    ...
    implements GizmoProperties {
        ...
        @Override
        public GizmoProperties persistForMillis(int n) {
            this.startTimeMillis = Util.getMillis();
            this.expireTimeMillis = this.startTimeMillis + (long)n;
            return this;
        }
        ...
        public float getAlphaMultiplier(long l) {
            if (this.shouldFadeOut) {
                long l2 = this.expireTimeMillis - this.startTimeMillis;
                long l3 = l - this.startTimeMillis;
                return 1.0f - Mth.clamp((float)l3 / (float)l2, 0.0f, 1.0f);
            }
            return 1.0f;
        }
