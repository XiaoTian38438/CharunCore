...
public class SpawnArmorTrimsCommand {
    ...
    private static int spawnArmorTrim(CommandSourceStack commandSourceStack, Player player, ResourceKey<TrimPattern> resourceKey) {
        return SpawnArmorTrimsCommand.spawnArmorTrims(commandSourceStack, player, Stream.of(commandSourceStack.getServer().registryAccess().lookupOrThrow(Registries.TRIM_PATTERN).get(resourceKey).orElseThrow()));
    }
