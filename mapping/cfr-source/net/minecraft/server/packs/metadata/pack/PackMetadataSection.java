...
public record PackMetadataSection(Component description, InclusiveRange<PackFormat> supportedFormats) {
    private static final Codec<PackMetadataSection> FALLBACK_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)ComponentSerialization.CODEC.fieldOf("description")).forGetter(PackMetadataSection::description)).apply((Applicative<PackMetadataSection, ?>)instance, component -> new PackMetadataSection((Component)component, new InclusiveRange<PackFormat>(PackFormat.of(Integer.MAX_VALUE)))));
    ...
    private static Codec<PackMetadataSection> codecForPackType(PackType packType) {
        return RecordCodecBuilder.create(instance -> instance.group(((MapCodec)ComponentSerialization.CODEC.fieldOf("description")).forGetter(PackMetadataSection::description), PackFormat.packCodec(packType).forGetter(PackMetadataSection::supportedFormats)).apply((Applicative<PackMetadataSection, ?>)instance, PackMetadataSection::new));
    }
