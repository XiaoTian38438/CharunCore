...
extends SimpleReloadInstance<State> {
    ...
    public static ReloadInstance of(ResourceManager resourceManager, List<PreparableReloadListener> list, Executor executor, Executor executor4, CompletableFuture<Unit> completableFuture) {
        ProfiledReloadInstance profiledReloadInstance = new ProfiledReloadInstance(list);
        profiledReloadInstance.startTasks(executor, executor4, resourceManager, list, (sharedState, preparationBarrier, preparableReloadListener, executor2, executor3) -> {
