...
{
    public static final MapCodec<CommandTemplate> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ParsedTemplate.CODEC.fieldOf("template")).forGetter(CommandTemplate::template)).apply((Applicative<CommandTemplate, ?>)instance, CommandTemplate::new));
