...
implements MinecraftServerSettingsService {
    ...
    @Override
    public int setMaxPlayers(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update max players from {} to {}", this.getMaxPlayers(), n);
    ...
    @Override
    public int setPauseWhenEmptySeconds(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update pause when empty from {} seconds to {} seconds", this.getPauseWhenEmptySeconds(), n);
        this.server.setPauseWhenEmptySeconds(n);
    ...
    @Override
    public int setPlayerIdleTimeout(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update player idle timeout from {} minutes to {} minutes", this.getPlayerIdleTimeout(), n);
        this.server.setPlayerIdleTimeout(n);
    ...
    @Override
    public int setSpawnProtectionRadius(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update spawn protection radius from {} to {}", this.getSpawnProtectionRadius(), n);
        this.server.setSpawnProtectionRadius(n);
    ...
    @Override
    public int setViewDistance(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update view distance from {} to {}", this.getViewDistance(), n);
        this.server.setViewDistance(n);
    ...
    @Override
    public int setSimulationDistance(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update simulation distance from {} to {}", this.getSimulationDistance(), n);
        this.server.setSimulationDistance(n);
    ...
    @Override
    public int setStatusHeartbeatInterval(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update status heartbeat interval from {} to {}", this.getStatusHeartbeatInterval(), n);
        this.server.setStatusHeartbeatInterval(n);
    ...
    @Override
    public int setEntityBroadcastRangePercentage(int n, ClientInfo clientInfo) {
        this.jsonrpcLogger.log(clientInfo, "Update entity broadcast range percentage from {}% to {}%", this.getEntityBroadcastRangePercentage(), n);
        this.server.setEntityBroadcastRangePercentage(n);
