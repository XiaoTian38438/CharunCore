...
public class PlayerService {
    ...
    public static List<PlayerDto> kick(MinecraftApi minecraftApi, List<KickDto> list, ClientInfo clientInfo) {
        ArrayList<PlayerDto> arrayList = new ArrayList<PlayerDto>();
    ...
    extends Record {
        ...
        public static final MapCodec<KickDto> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)PlayerDto.CODEC.codec().fieldOf("player")).forGetter(KickDto::player), Message.CODEC.optionalFieldOf("message").forGetter(KickDto::message)).apply((Applicative<KickDto, ?>)instance, KickDto::new));
