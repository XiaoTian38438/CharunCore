...
public class ServerSettingsService {
    ...
    public static int setMaxPlayers(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setMaxPlayers(n, clientInfo);
    }
    ...
    public static int setPauseWhenEmpty(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setPauseWhenEmptySeconds(n, clientInfo);
    }
    ...
    public static int setPlayerIdleTimeout(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setPlayerIdleTimeout(n, clientInfo);
    }
    ...
    public static int setSpawnProtection(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setSpawnProtectionRadius(n, clientInfo);
    }
    ...
    public static int setViewDistance(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setViewDistance(n, clientInfo);
    }
    ...
    public static int setSimulationDistance(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setSimulationDistance(n, clientInfo);
    }
    ...
    public static int setStatusHeartbeatInterval(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setStatusHeartbeatInterval(n, clientInfo);
    }
    ...
    public static int setEntityBroadcastRangePercentage(MinecraftApi minecraftApi, int n, ClientInfo clientInfo) {
        return minecraftApi.serverSettingsService().setEntityBroadcastRangePercentage(n, clientInfo);
    }
}
