...
public class ServerStateService {
    ...
    public record ServerState(boolean started, List<PlayerDto> players, ServerStatus.Version version) {
        public static final Codec<ServerState> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.BOOL.fieldOf("started")).forGetter(ServerState::started), PlayerDto.CODEC.codec().listOf().lenientOptionalFieldOf("players", List.of()).forGetter(ServerState::players), ((MapCodec)ServerStatus.Version.CODEC.fieldOf("version")).forGetter(ServerState::version)).apply((Applicative<ServerState, ?>)instance, ServerState::new));
    ...
    public record SystemMessage(Message message, boolean overlay, Optional<List<PlayerDto>> receivingPlayers) {
        public static final Codec<SystemMessage> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Message.CODEC.fieldOf("message")).forGetter(SystemMessage::message), ((MapCodec)Codec.BOOL.fieldOf("overlay")).forGetter(SystemMessage::overlay), PlayerDto.CODEC.codec().listOf().lenientOptionalFieldOf("receivingPlayers").forGetter(SystemMessage::receivingPlayers)).apply((Applicative<SystemMessage, ?>)instance, SystemMessage::new));
    }
}
