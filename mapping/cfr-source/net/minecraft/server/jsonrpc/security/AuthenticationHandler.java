...
extends ChannelDuplexHandler {
    ...
    public void channelRead(ChannelHandlerContext channelHandlerContext, Object object) throws Exception {
        ...
        if (object instanceof HttpRequest) {
            ...
            SecurityCheckResult securityCheckResult = this.performSecurityChecks((HttpRequest)object2);
        ...
        if (Boolean.TRUE.equals(object2 = (Boolean)channelHandlerContext.channel().attr(AUTHENTICATED_KEY).get())) {
    ...
    public boolean isValidApiKey(String string) {
        ...
        byte[] byArray2 = this.securityConfig.secretKey().getBytes(StandardCharsets.UTF_8);
