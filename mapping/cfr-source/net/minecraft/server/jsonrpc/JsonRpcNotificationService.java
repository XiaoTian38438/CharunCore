...
implements NotificationService {
    ...
    public <T> void onGameRuleChanged(GameRule<T> gameRule, T t) {
        this.broadcastNotification(OutgoingRpcMethods.GAMERULE_CHANGED, GameRulesService.getTypedRule(this.minecraftApi, gameRule, t));
    }
    ...
    private <Params> void broadcastNotification(Holder.Reference<? extends OutgoingRpcMethod<Params, ?>> reference, Params Params) {
        this.managementServer.forEachConnection(connection -> connection.sendNotification(reference, Params));
    }
}
