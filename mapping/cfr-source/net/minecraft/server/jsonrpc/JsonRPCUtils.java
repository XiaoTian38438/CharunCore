...
public class JsonRPCUtils {
    ...
    public static JsonObject createRequest(@Nullable Integer n, Identifier identifier, List<JsonElement> list) {
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("jsonrpc", JSON_RPC_VERSION);
        if (n != null) {
    ...
    public static JsonObject createError(JsonElement jsonElement, String string, int n, @Nullable String string2) {
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("jsonrpc", JSON_RPC_VERSION);
        jsonObject.add("id", jsonElement);
