...
public abstract class StoredUserList<K, V extends StoredUserEntry<K>> {
    ...
    public boolean add(V v) {
        String string = this.getKeyForUser(((StoredUserEntry)v).getUser());
        StoredUserEntry storedUserEntry = (StoredUserEntry)this.map.get(string);
        if (v.equals(storedUserEntry)) {
            return false;
        }
    ...
    public boolean remove(K k) {
        StoredUserEntry storedUserEntry = (StoredUserEntry)this.map.remove(this.getKeyForUser(k));
