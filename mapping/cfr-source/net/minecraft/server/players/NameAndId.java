...
public record NameAndId(UUID id, String name) {
    public static final Codec<NameAndId> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)UUIDUtil.STRING_CODEC.fieldOf("id")).forGetter(NameAndId::id), ((MapCodec)Codec.STRING.fieldOf("name")).forGetter(NameAndId::name)).apply((Applicative<NameAndId, ?>)instance, NameAndId::new));
