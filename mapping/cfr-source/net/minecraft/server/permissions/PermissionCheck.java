...
public interface PermissionCheck {
    ...
    {
        public static final MapCodec<Require> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Permission.CODEC.fieldOf("permission")).forGetter(Require::permission)).apply((Applicative<Require, ?>)instance, Require::new));
