...
public record ServerLinks(List<Entry> entries) {
    ...
    public Optional<Entry> findKnownType(KnownLinkType knownLinkType) {
        return this.entries.stream().filter(entry -> entry.type.map(knownLinkType2 -> knownLinkType2 == knownLinkType, component -> false)).findFirst();
    }
    ...
    extends Record {
        ...
        public Component displayName() {
            return this.type.map(KnownLinkType::displayName, component -> component);
        }
