...
public class CustomBossEvents {
    ...
    public void load(CompoundTag compoundTag, HolderLookup.Provider provider) {
        Map<Identifier, CustomBossEvent.Packed> map = EVENTS_CODEC.parse(provider.createSerializationContext(NbtOps.INSTANCE), compoundTag).resultOrPartial(string -> LOGGER.error("Failed to parse boss bar events: {}", string)).orElse(Map.of());
