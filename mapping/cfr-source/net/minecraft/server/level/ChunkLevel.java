...
public class ChunkLevel {
    ...
    public static @Nullable ChunkStatus generationStatus(int n) {
        return ChunkLevel.getStatusAroundFullChunk(n - 33, null);
    }

    @Contract(value="_,!null->!null;_,_->_")
    public static @Nullable ChunkStatus getStatusAroundFullChunk(int n, @Nullable ChunkStatus chunkStatus) {
