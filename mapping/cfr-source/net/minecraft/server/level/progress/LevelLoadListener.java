    ...
    public static LevelLoadListener compose(final LevelLoadListener levelLoadListener, final LevelLoadListener levelLoadListener2) {
        return new LevelLoadListener(){
            ...
            public void start(Stage stage, int n) {
                levelLoadListener.start(stage, n);
                levelLoadListener2.start(stage, n);
            }

            @Override
            public void update(Stage stage, int n, int n2) {
                levelLoadListener.update(stage, n, n2);
                levelLoadListener2.update(stage, n, n2);
            }
