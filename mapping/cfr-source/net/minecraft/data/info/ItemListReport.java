    ...
    public CompletableFuture<?> run(CachedOutput cachedOutput) {
        ...
        return this.registries.thenCompose(provider -> {
            ...
            provider.lookupOrThrow(Registries.ITEM).listElements().forEach(reference -> {
                ...
                jsonObject2.add("components", (JsonElement)DataComponentMap.CODEC.encodeStart(registryOps, ((Item)reference.value()).components()).getOrThrow(string -> new IllegalStateException("Failed to encode components: " + string)));
