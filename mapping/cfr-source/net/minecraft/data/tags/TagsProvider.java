...
implements DataProvider {
    ...
    public CompletableFuture<?> run(CachedOutput cachedOutput) {
        ...
        return ((CompletableFuture)((CompletableFuture)this.createContentsProvider().thenApply(provider -> {
            ...
            Predicate<Identifier> predicate = arg_0 -> this.lambda$run$2((HolderLookup.RegistryLookup)holderGetter, arg_0);
            Predicate<Identifier> predicate2 = identifier -> this.builders.containsKey(identifier) || combinedData.parent.contains(TagKey.create(this.registryKey, identifier));
