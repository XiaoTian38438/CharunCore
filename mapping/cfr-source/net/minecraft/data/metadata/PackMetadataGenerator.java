...
implements DataProvider {
    ...
    public <T> PackMetadataGenerator add(MetadataSectionType<T> metadataSectionType, T t) {
        this.elements.put(metadataSectionType.name(), () -> metadataSectionType.codec().encodeStart(JsonOps.INSTANCE, (JsonElement)t).getOrThrow(IllegalArgumentException::new).getAsJsonObject());
        return this;
    }
