...
public class BiomeDefaultFeatures {
    ...
    public static void commonSpawns(MobSpawnSettings.Builder builder, int n) {
        ...
        BiomeDefaultFeatures.monsters(builder, 95, 5, 0, n, false);
    }
    ...
    public static void swampSpawns(MobSpawnSettings.Builder builder, int n) {
        BiomeDefaultFeatures.commonSpawns(builder, n);
    ...
    public static void monsters(MobSpawnSettings.Builder builder, int n, int n2, int n3, int n4, boolean bl) {
        ...
        if (n3 > 0) {
            builder.addSpawn(MobCategory.MONSTER, n3, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_HORSE, 1, 1));
        }
        builder.addSpawn(MobCategory.MONSTER, n4, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 4, 4));
