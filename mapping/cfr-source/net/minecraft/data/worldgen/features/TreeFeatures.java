...
public class TreeFeatures {
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenBirch(int n) {
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenTrees(Block block, int n, int n2) {
        return new FallenTreeConfiguration.FallenTreeConfigurationBuilder(BlockStateProvider.simple(block), UniformInt.of(n, n2)).logDecorators((List<TreeDecorator>)ImmutableList.of((Object)new AttachedToLogsDecorator(0.1f, new WeightedStateProvider(WeightedList.builder().add(Blocks.RED_MUSHROOM.defaultBlockState(), 2).add(Blocks.BROWN_MUSHROOM.defaultBlockState(), 1)), List.of(Direction.UP))));
    }
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
        ...
        FeatureUtils.register(bootstrapContext, OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators(List.of(beehiveDecorator, placeOnGroundDecorator, placeOnGroundDecorator2)).build());
        ...
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehiveDecorator, placeOnGroundDecorator, placeOnGroundDecorator2)).build());
        ...
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehiveDecorator, placeOnGroundDecorator, placeOnGroundDecorator2)).build());
        ...
        FeatureUtils.register(bootstrapContext, FANCY_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(placeOnGroundDecorator, placeOnGroundDecorator2)).build());
