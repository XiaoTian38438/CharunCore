...
public class OreFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
        ...
        TagMatchTest tagMatchTest4 = new TagMatchTest(BlockTags.BASE_STONE_NETHER);
        List<OreConfiguration.TargetBlockState> list = List.of(OreConfiguration.target(tagMatchTest2, Blocks.IRON_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_IRON_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> list2 = List.of(OreConfiguration.target(tagMatchTest2, Blocks.GOLD_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_GOLD_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> list3 = List.of(OreConfiguration.target(tagMatchTest2, Blocks.DIAMOND_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_DIAMOND_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> list4 = List.of(OreConfiguration.target(tagMatchTest2, Blocks.LAPIS_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_LAPIS_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> list5 = List.of(OreConfiguration.target(tagMatchTest2, Blocks.COPPER_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_COPPER_ORE.defaultBlockState()));
        List<OreConfiguration.TargetBlockState> list6 = List.of(OreConfiguration.target(tagMatchTest2, Blocks.COAL_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_COAL_ORE.defaultBlockState()));
        FeatureUtils.register(bootstrapContext, ORE_MAGMA, Feature.ORE, new OreConfiguration(blockMatchTest, Blocks.MAGMA_BLOCK.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapContext, ORE_SOUL_SAND, Feature.ORE, new OreConfiguration(blockMatchTest, Blocks.SOUL_SAND.defaultBlockState(), 12));
        FeatureUtils.register(bootstrapContext, ORE_NETHER_GOLD, Feature.ORE, new OreConfiguration(blockMatchTest, Blocks.NETHER_GOLD_ORE.defaultBlockState(), 10));
        FeatureUtils.register(bootstrapContext, ORE_QUARTZ, Feature.ORE, new OreConfiguration(blockMatchTest, Blocks.NETHER_QUARTZ_ORE.defaultBlockState(), 14));
        FeatureUtils.register(bootstrapContext, ORE_GRAVEL_NETHER, Feature.ORE, new OreConfiguration(blockMatchTest, Blocks.GRAVEL.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapContext, ORE_BLACKSTONE, Feature.ORE, new OreConfiguration(blockMatchTest, Blocks.BLACKSTONE.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapContext, ORE_DIRT, Feature.ORE, new OreConfiguration(tagMatchTest, Blocks.DIRT.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapContext, ORE_GRAVEL, Feature.ORE, new OreConfiguration(tagMatchTest, Blocks.GRAVEL.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapContext, ORE_GRANITE, Feature.ORE, new OreConfiguration(tagMatchTest, Blocks.GRANITE.defaultBlockState(), 64));
        FeatureUtils.register(bootstrapContext, ORE_DIORITE, Feature.ORE, new OreConfiguration(tagMatchTest, Blocks.DIORITE.defaultBlockState(), 64));
        FeatureUtils.register(bootstrapContext, ORE_ANDESITE, Feature.ORE, new OreConfiguration(tagMatchTest, Blocks.ANDESITE.defaultBlockState(), 64));
        FeatureUtils.register(bootstrapContext, ORE_TUFF, Feature.ORE, new OreConfiguration(tagMatchTest, Blocks.TUFF.defaultBlockState(), 64));
        ...
        FeatureUtils.register(bootstrapContext, ORE_REDSTONE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(tagMatchTest2, Blocks.REDSTONE_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_REDSTONE_ORE.defaultBlockState())), 8));
        ...
        FeatureUtils.register(bootstrapContext, ORE_INFESTED, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(tagMatchTest2, Blocks.INFESTED_STONE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.INFESTED_DEEPSLATE.defaultBlockState())), 9));
        FeatureUtils.register(bootstrapContext, ORE_EMERALD, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(tagMatchTest2, Blocks.EMERALD_ORE.defaultBlockState()), OreConfiguration.target(tagMatchTest3, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())), 3));
        FeatureUtils.register(bootstrapContext, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreConfiguration(tagMatchTest4, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0f));
        FeatureUtils.register(bootstrapContext, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreConfiguration(tagMatchTest4, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0f));
        ...
        FeatureUtils.register(bootstrapContext, ORE_CLAY, Feature.ORE, new OreConfiguration(tagMatchTest, Blocks.CLAY.defaultBlockState(), 33));
    }
}
