...
{
    public static final MapCodec<EntityDataSource> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.STRING.fieldOf("entity")).forGetter(EntityDataSource::selectorPattern)).apply((Applicative<EntityDataSource, ?>)instance, EntityDataSource::new));
