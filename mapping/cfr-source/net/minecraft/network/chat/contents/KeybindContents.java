...
implements ComponentContents {
    public static final MapCodec<KeybindContents> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.STRING.fieldOf("keybind")).forGetter(keybindContents -> keybindContents.name)).apply((Applicative<KeybindContents, ?>)instance, KeybindContents::new));
