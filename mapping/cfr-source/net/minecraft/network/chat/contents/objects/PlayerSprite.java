...
{
    public static final MapCodec<PlayerSprite> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ResolvableProfile.CODEC.fieldOf("player")).forGetter(PlayerSprite::player), Codec.BOOL.optionalFieldOf("hat", true).forGetter(PlayerSprite::hat)).apply((Applicative<PlayerSprite, ?>)instance, PlayerSprite::new));
