...
public record AtlasSprite(Identifier atlas, Identifier sprite) implements ObjectInfo
{
    ...
    public static final MapCodec<AtlasSprite> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Identifier.CODEC.optionalFieldOf("atlas", DEFAULT_ATLAS).forGetter(AtlasSprite::atlas), ((MapCodec)Identifier.CODEC.fieldOf("sprite")).forGetter(AtlasSprite::sprite)).apply((Applicative<AtlasSprite, ?>)instance, AtlasSprite::new));
