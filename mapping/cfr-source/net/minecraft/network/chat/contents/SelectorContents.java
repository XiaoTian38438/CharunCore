...
{
    public static final MapCodec<SelectorContents> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)SelectorPattern.CODEC.fieldOf("selector")).forGetter(SelectorContents::selector), ComponentSerialization.CODEC.optionalFieldOf("separator").forGetter(SelectorContents::separator)).apply((Applicative<SelectorContents, ?>)instance, SelectorContents::new));
