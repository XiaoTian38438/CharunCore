...
implements Packet<ServerGamePacketListener> {
    ...
    public ServerboundSetJigsawBlockPacket(BlockPos blockPos, Identifier identifier, Identifier identifier2, Identifier identifier3, String string, JigsawBlockEntity.JointType jointType, int n, int n2) {
        this.pos = blockPos;
