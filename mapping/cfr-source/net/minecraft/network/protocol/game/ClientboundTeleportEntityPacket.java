...
public record ClientboundTeleportEntityPacket(int id, PositionMoveRotation change, Set<Relative> relatives, boolean onGround) implements Packet<ClientGamePacketListener>
{
    ...
    public static ClientboundTeleportEntityPacket teleport(int n, PositionMoveRotation positionMoveRotation, Set<Relative> set, boolean bl) {
        return new ClientboundTeleportEntityPacket(n, positionMoveRotation, set, bl);
    }
