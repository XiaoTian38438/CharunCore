...
public enum ChatFormatting implements StringRepresentable
{
    ...
    public static @Nullable ChatFormatting getById(int n) {
        if (n < 0) {
            return RESET;
        }
    ...
    static {
        ...
        COLOR_CODEC = CODEC.validate(chatFormatting -> chatFormatting.isFormat() ? DataResult.error(() -> "Formatting was not a valid color: " + String.valueOf(chatFormatting)) : DataResult.success(chatFormatting));
