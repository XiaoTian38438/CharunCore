...
public interface TestEnvironmentDefinition {
    ...
    {
        public static final MapCodec<AllOf> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)CODEC.listOf().fieldOf("definitions")).forGetter(AllOf::definitions)).apply((Applicative<AllOf, ?>)instance, AllOf::new));
    ...
    {
        public static final MapCodec<SetGameRules> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)GameRuleMap.CODEC.fieldOf("rules")).forGetter(SetGameRules::gameRulesMap)).apply((Applicative<SetGameRules, ?>)instance, SetGameRules::new));
    ...
    {
        public static final MapCodec<TimeOfDay> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ExtraCodecs.NON_NEGATIVE_INT.fieldOf("time")).forGetter(TimeOfDay::time)).apply((Applicative<TimeOfDay, ?>)instance, TimeOfDay::new));
    ...
    {
        public static final MapCodec<Weather> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Type.CODEC.fieldOf("weather")).forGetter(Weather::weather)).apply((Applicative<Weather, ?>)instance, Weather::new));
    ...
    public record Functions(Optional<Identifier> setupFunction, Optional<Identifier> teardownFunction) implements TestEnvironmentDefinition
    {
        ...
        public static final MapCodec<Functions> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Identifier.CODEC.optionalFieldOf("setup").forGetter(Functions::setupFunction), Identifier.CODEC.optionalFieldOf("teardown").forGetter(Functions::teardownFunction)).apply((Applicative<Functions, ?>)instance, Functions::new));
