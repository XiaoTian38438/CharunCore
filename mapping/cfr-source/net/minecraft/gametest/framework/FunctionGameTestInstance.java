...
extends GameTestInstance {
    public static final MapCodec<FunctionGameTestInstance> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)ResourceKey.codec(Registries.TEST_FUNCTION).fieldOf("function")).forGetter(FunctionGameTestInstance::function), TestData.CODEC.forGetter(GameTestInstance::info)).apply((Applicative<FunctionGameTestInstance, ?>)instance, FunctionGameTestInstance::new));
