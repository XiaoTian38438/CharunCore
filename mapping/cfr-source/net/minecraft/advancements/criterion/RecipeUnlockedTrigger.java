...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    {
        public static final Codec<TriggerInstance> CODEC = RecordCodecBuilder.create(instance -> instance.group(EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(TriggerInstance::player), ((MapCodec)Recipe.KEY_CODEC.fieldOf("recipe")).forGetter(TriggerInstance::recipe)).apply((Applicative<TriggerInstance, ?>)instance, TriggerInstance::new));
