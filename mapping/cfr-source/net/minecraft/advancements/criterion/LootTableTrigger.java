...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    {
        public static final Codec<TriggerInstance> CODEC = RecordCodecBuilder.create(instance -> instance.group(EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(TriggerInstance::player), ((MapCodec)LootTable.KEY_CODEC.fieldOf("loot_table")).forGetter(TriggerInstance::lootTable)).apply((Applicative<TriggerInstance, ?>)instance, TriggerInstance::new));
