...
{
    public static final Codec<BundlePredicate> CODEC = RecordCodecBuilder.create(instance -> instance.group(CollectionPredicate.codec(ItemPredicate.CODEC).optionalFieldOf("items").forGetter(BundlePredicate::items)).apply((Applicative<BundlePredicate, ?>)instance, BundlePredicate::new));
