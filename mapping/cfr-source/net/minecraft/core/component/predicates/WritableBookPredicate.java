...
{
    public static final Codec<WritableBookPredicate> CODEC = RecordCodecBuilder.create(instance -> instance.group(CollectionPredicate.codec(PagePredicate.CODEC).optionalFieldOf("pages").forGetter(WritableBookPredicate::pages)).apply((Applicative<WritableBookPredicate, ?>)instance, WritableBookPredicate::new));
