...
implements ParticleOptions {
    ...
    public static MapCodec<PowerParticleOption> codec(ParticleType<PowerParticleOption> particleType) {
        return Codec.FLOAT.xmap(f -> new PowerParticleOption(particleType, f.floatValue()), powerParticleOption -> Float.valueOf(powerParticleOption.power)).optionalFieldOf("power", PowerParticleOption.create(particleType, 1.0f));
    }

    public static StreamCodec<? super ByteBuf, PowerParticleOption> streamCodec(ParticleType<PowerParticleOption> particleType) {
        return ByteBufCodecs.FLOAT.map(f -> new PowerParticleOption(particleType, f.floatValue()), powerParticleOption -> Float.valueOf(powerParticleOption.power));
    }
