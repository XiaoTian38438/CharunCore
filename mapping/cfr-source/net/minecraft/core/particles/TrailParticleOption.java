...
{
    public static final MapCodec<TrailParticleOption> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Vec3.CODEC.fieldOf("target")).forGetter(TrailParticleOption::target), ((MapCodec)ExtraCodecs.RGB_COLOR_CODEC.fieldOf("color")).forGetter(TrailParticleOption::color), ((MapCodec)ExtraCodecs.POSITIVE_INT.fieldOf("duration")).forGetter(TrailParticleOption::duration)).apply((Applicative<TrailParticleOption, ?>)instance, TrailParticleOption::new));
