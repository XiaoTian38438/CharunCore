    ...
    public Result<T> parse(StringReader stringReader) throws CommandSyntaxException {
        if (stringReader.canRead() && stringReader.peek() == '#') {
            ...
            try {
                ...
                HolderSet.Named named = this.registryLookup.get(tagKey).orElseThrow(() -> ERROR_UNKNOWN_TAG.createWithContext(stringReader, identifier, this.registryKey.identifier()));
        ...
        Holder.Reference reference = this.registryLookup.get(resourceKey).orElseThrow(() -> ResourceArgument.ERROR_UNKNOWN_RESOURCE.createWithContext(stringReader, identifier, this.registryKey.identifier()));
