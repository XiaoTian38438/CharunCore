...
/*    */   
/*    */   default <A, B, C> App2<P, A, C> compose(App2<P, B, C> paramApp2, Supplier<App2<P, A, B>> paramSupplier) {
/* 20 */     return plus((App2<Procompose.Mu<P, P>, A, C>)new Procompose(paramSupplier, paramApp2));
/*    */   }
/*    */   
...
/* Location:              C:\Users\tian_\Desktop\mc-server-core1.21.11\mapping\deobf-work\remapped_server_1.21.11.jar!\com\mojang\datafixers\optics\profunctors\MonoidProfunctor.class
