...
/*     */   
/*     */   public <A> App<RecordCodecBuilder.Mu<O>, A> stable(A paramA) {
/* 131 */     return RecordCodecBuilder.stable(paramA);
/*     */   }
/*     */   
/*     */   public <A> App<RecordCodecBuilder.Mu<O>, A> deprecated(A paramA, int paramInt) {
/* 135 */     return RecordCodecBuilder.deprecated(paramA, paramInt);
/*     */   }
/*     */   
/*     */   public <A> App<RecordCodecBuilder.Mu<O>, A> point(A paramA, Lifecycle paramLifecycle) {
/* 139 */     return RecordCodecBuilder.point(paramA, paramLifecycle);
/*     */   }
/*     */ 
/*     */   
/*     */   public <A> App<RecordCodecBuilder.Mu<O>, A> point(A paramA) {
/* 144 */     return RecordCodecBuilder.point(paramA);
/*     */   }
/*     */ 
/*     */   
/*     */   public <A, R> Function<App<RecordCodecBuilder.Mu<O>, A>, App<RecordCodecBuilder.Mu<O>, R>> lift1(App<RecordCodecBuilder.Mu<O>, Function<A, R>> paramApp) {
/* 149 */     return paramApp2 -> {
/*     */         final RecordCodecBuilder<?, ?> f = RecordCodecBuilder.unbox(paramApp1);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/*     */         final RecordCodecBuilder<?, ?> a = RecordCodecBuilder.unbox(paramApp2);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public <A, B, R> App<RecordCodecBuilder.Mu<O>, R> ap2(App<RecordCodecBuilder.Mu<O>, BiFunction<A, B, R>> paramApp, App<RecordCodecBuilder.Mu<O>, A> paramApp1, App<RecordCodecBuilder.Mu<O>, B> paramApp2) {
/* 206 */     final RecordCodecBuilder<O, BiFunction<A, B, R>> function = RecordCodecBuilder.unbox(paramApp);
/* 207 */     final RecordCodecBuilder<O, A> fa = RecordCodecBuilder.unbox(paramApp1);
/* 208 */     final RecordCodecBuilder<O, B> fb = RecordCodecBuilder.unbox(paramApp2);
/*     */     
/* 210 */     return new RecordCodecBuilder<>(paramObject -> ((BiFunction)paramRecordCodecBuilder1.getter.apply(paramObject)).apply(paramRecordCodecBuilder2.getter.apply(paramObject), paramRecordCodecBuilder3.getter.apply(paramObject)), paramObject -> {
/*     */           final MapEncoder fEncoder = paramRecordCodecBuilder1.encoder.apply(paramObject);
/*     */           
/*     */           final MapEncoder aEncoder = paramRecordCodecBuilder2.encoder.apply(paramObject);
/*     */           
/*     */           final Object aFromO = paramRecordCodecBuilder2.getter.apply(paramObject);
/*     */           final MapEncoder bEncoder = paramRecordCodecBuilder3.encoder.apply(paramObject);
/*     */           final Object bFromO = paramRecordCodecBuilder3.getter.apply(paramObject);
...
/*     */ 
/*     */   
/*     */   public <T1, T2, T3, R> App<RecordCodecBuilder.Mu<O>, R> ap3(App<RecordCodecBuilder.Mu<O>, Function3<T1, T2, T3, R>> paramApp, App<RecordCodecBuilder.Mu<O>, T1> paramApp1, App<RecordCodecBuilder.Mu<O>, T2> paramApp2, App<RecordCodecBuilder.Mu<O>, T3> paramApp3) {
/* 272 */     final RecordCodecBuilder<O, Function3<T1, T2, T3, R>> function = RecordCodecBuilder.unbox(paramApp);
/* 273 */     final RecordCodecBuilder<O, T1> f1 = RecordCodecBuilder.unbox(paramApp1);
/* 274 */     final RecordCodecBuilder<O, T2> f2 = RecordCodecBuilder.unbox(paramApp2);
/* 275 */     final RecordCodecBuilder<O, T3> f3 = RecordCodecBuilder.unbox(paramApp3);
/*     */     
/* 277 */     return new RecordCodecBuilder<>(paramObject -> ((Function3)paramRecordCodecBuilder1.getter.apply(paramObject)).apply(paramRecordCodecBuilder2.getter.apply(paramObject), paramRecordCodecBuilder3.getter.apply(paramObject), paramRecordCodecBuilder4.getter.apply(paramObject)), paramObject -> {
/*     */           final MapEncoder fEncoder = paramRecordCodecBuilder1.encoder.apply(paramObject);
/*     */           
/*     */           final MapEncoder e1 = paramRecordCodecBuilder2.encoder.apply(paramObject);
/*     */           
/*     */           final Object v1 = paramRecordCodecBuilder2.getter.apply(paramObject);
/*     */           
/*     */           final MapEncoder e2 = paramRecordCodecBuilder3.encoder.apply(paramObject);
/*     */           
/*     */           final Object v2 = paramRecordCodecBuilder3.getter.apply(paramObject);
/*     */           
/*     */           final MapEncoder e3 = paramRecordCodecBuilder4.encoder.apply(paramObject);
/*     */           
/*     */           final Object v3 = paramRecordCodecBuilder4.getter.apply(paramObject);
/*     */           return (MapEncoder)new MapEncoder.Implementation<R>()
/*     */             {
/*     */               public <T> RecordBuilder<T> encode(R param2R, DynamicOps<T> param2DynamicOps, RecordBuilder<T> param2RecordBuilder)
/*     */               {
...
/*     */ 
/*     */   
/*     */   public <T1, T2, T3, T4, R> App<RecordCodecBuilder.Mu<O>, R> ap4(App<RecordCodecBuilder.Mu<O>, Function4<T1, T2, T3, T4, R>> paramApp, App<RecordCodecBuilder.Mu<O>, T1> paramApp1, App<RecordCodecBuilder.Mu<O>, T2> paramApp2, App<RecordCodecBuilder.Mu<O>, T3> paramApp3, App<RecordCodecBuilder.Mu<O>, T4> paramApp4) {
/* 349 */     final RecordCodecBuilder<O, Function4<T1, T2, T3, T4, R>> function = RecordCodecBuilder.unbox(paramApp);
/* 350 */     final RecordCodecBuilder<O, T1> f1 = RecordCodecBuilder.unbox(paramApp1);
/* 351 */     final RecordCodecBuilder<O, T2> f2 = RecordCodecBuilder.unbox(paramApp2);
/* 352 */     final RecordCodecBuilder<O, T3> f3 = RecordCodecBuilder.unbox(paramApp3);
/* 353 */     final RecordCodecBuilder<O, T4> f4 = RecordCodecBuilder.unbox(paramApp4);
/*     */     
/* 355 */     return new RecordCodecBuilder<>(paramObject -> ((Function4)paramRecordCodecBuilder1.getter.apply(paramObject)).apply(paramRecordCodecBuilder2.getter.apply(paramObject), paramRecordCodecBuilder3.getter.apply(paramObject), paramRecordCodecBuilder4.getter.apply(paramObject), paramRecordCodecBuilder5.getter.apply(paramObject)), paramObject -> {
/*     */           final MapEncoder fEncoder = paramRecordCodecBuilder1.encoder.apply(paramObject);
/*     */           
/*     */           final MapEncoder e1 = paramRecordCodecBuilder2.encoder.apply(paramObject);
/*     */           
...
/*     */           final Object v3 = paramRecordCodecBuilder4.getter.apply(paramObject);
/*     */           
/*     */           final MapEncoder e4 = paramRecordCodecBuilder5.encoder.apply(paramObject);
/*     */           final Object v4 = paramRecordCodecBuilder5.getter.apply(paramObject);
/*     */           return (MapEncoder)new MapEncoder.Implementation<R>()
/*     */             {
/*     */               public <T> RecordBuilder<T> encode(R param2R, DynamicOps<T> param2DynamicOps, RecordBuilder<T> param2RecordBuilder)
/*     */               {
...
/*     */ 
/*     */   
/*     */   public <T, R> App<RecordCodecBuilder.Mu<O>, R> map(final Function<? super T, ? extends R> getter, App<RecordCodecBuilder.Mu<O>, T> paramApp) {
/* 434 */     RecordCodecBuilder<O, T> recordCodecBuilder = RecordCodecBuilder.unbox(paramApp);
/* 435 */     Function<O, T> function = recordCodecBuilder.getter;
/* 436 */     return new RecordCodecBuilder<>(function
/* 437 */         .andThen(getter), paramObject -> new MapEncoder.Implementation<R>()
/*     */         {
...
/* Location:              C:\Users\tian_\Desktop\mc-server-core1.21.11\mapping\deobf-work\remapped_server_1.21.11.jar!\com\mojang\serialization\codecs\RecordCodecBuilder$Instance.class
