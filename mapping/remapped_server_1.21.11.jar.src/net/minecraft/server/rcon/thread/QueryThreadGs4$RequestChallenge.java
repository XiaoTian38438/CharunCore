...
/*     */ {
/* 328 */   private final long time = (new Date()).getTime(); private final int challenge; private final byte[] identBytes; public RequestChallenge(DatagramPacket paramDatagramPacket) {
/* 329 */     byte[] arrayOfByte = paramDatagramPacket.getData();
...
/*     */   public Boolean before(long paramLong) {
/* 341 */     return Boolean.valueOf((this.time < paramLong));
/*     */   }
/*     */   
