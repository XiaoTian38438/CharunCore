...
/*    */   extends Schema
/*    */ {
/*    */   public V106(int paramInt, Schema paramSchema) {
...
/*    */     
/* 24 */     paramSchema.registerType(true, References.UNTAGGED_SPAWNER, () -> DSL.optionalFields("SpawnPotentials", DSL.list(DSL.fields("Entity", References.ENTITY_TREE.in(paramSchema))), "SpawnData", References.ENTITY_TREE.in(paramSchema)));
/*    */   }
/*    */ }
