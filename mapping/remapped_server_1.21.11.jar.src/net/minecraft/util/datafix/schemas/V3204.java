...
/*    */ {
/*    */   public V3204(int paramInt, Schema paramSchema) {
...
/* 21 */     paramSchema.register(map, "minecraft:chiseled_bookshelf", () -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(paramSchema))));
/*    */ 
/*    */     
/* 24 */     return map;
/*    */   }
