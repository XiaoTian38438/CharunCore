...
/*    */ {
/*    */   public V3082(int paramInt, Schema paramSchema) {
...
/*    */     
/* 22 */     paramSchema.register(map, "minecraft:chest_boat", paramString -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(paramSchema))));
/*    */ 
/*    */     
/* 25 */     return map;
/*    */   }
