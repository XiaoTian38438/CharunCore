...
/*    */ {
/*    */   public V3685(int paramInt, Schema paramSchema) {
...
/* 28 */     Map<String, Supplier<TypeTemplate>> map = super.registerEntities(paramSchema);
/* 29 */     paramSchema.register(map, "minecraft:trident", () -> abstractArrow(paramSchema));
