...
/* 65 */     .build();
/*    */   
/*    */   public AdvancementsFix(Schema paramSchema, boolean paramBoolean) {
/* 68 */     super(paramSchema, paramBoolean, "AdvancementsFix", paramString -> (String)RENAMES.getOrDefault(paramString, paramString));
/*    */   }
/*    */ }
