...
/*    */   
/*    */   public EntityTheRenameningFix(Schema paramSchema, boolean paramBoolean) {
/* 52 */     super("EntityTheRenameningBlock", paramSchema, paramBoolean);
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   protected String rename(String paramString) {
/* 58 */     if (paramString.startsWith("minecraft:bred_")) {
/* 59 */       paramString = "minecraft:" + paramString.substring("minecraft:bred_".length());
/*    */     }
/* 61 */     return RENAMED_IDS.getOrDefault(paramString, paramString);
/*    */   }
/*    */ }
