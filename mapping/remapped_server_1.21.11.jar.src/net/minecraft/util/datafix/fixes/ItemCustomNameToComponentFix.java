...
/*    */   public ItemCustomNameToComponentFix(Schema paramSchema) {
...
/* 24 */     OpticFinder opticFinder3 = opticFinder2.type().findField("Name");
/* 25 */     OpticFinder opticFinder4 = DSL.typeFinder(type2);
/*    */     
/* 27 */     return fixTypeEverywhereTyped("ItemCustomNameToComponentFix", type1, paramTyped -> paramTyped.updateTyped(paramOpticFinder1, ()));
/*    */   }
/*    */ }
