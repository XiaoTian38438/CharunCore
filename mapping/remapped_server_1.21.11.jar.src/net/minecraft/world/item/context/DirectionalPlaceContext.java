...
/*    */   public DirectionalPlaceContext(Level paramLevel, BlockPos paramBlockPos, Direction paramDirection1, ItemStack paramItemStack, Direction paramDirection2) {
/* 15 */     super(paramLevel, (Player)null, InteractionHand.MAIN_HAND, paramItemStack, new BlockHitResult(Vec3.atBottomCenterOf((Vec3i)paramBlockPos), paramDirection2, paramBlockPos, false));
/*    */     
/* 17 */     this.direction = paramDirection1;
/*    */   }
