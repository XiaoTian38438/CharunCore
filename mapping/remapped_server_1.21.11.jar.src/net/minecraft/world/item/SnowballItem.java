...
/*    */   
/*    */   public SnowballItem(Item.Properties paramProperties) {
...
/* 27 */     paramLevel.playSound(null, paramPlayer.getX(), paramPlayer.getY(), paramPlayer.getZ(), SoundEvents.SNOWBALL_THROW, SoundSource.NEUTRAL, 0.5F, 0.4F / (paramLevel.getRandom().nextFloat() * 0.4F + 0.8F));
/* 28 */     if (paramLevel instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)paramLevel;
/* 29 */       Projectile.spawnProjectileFromRotation(Snowball::new, serverLevel, itemStack, (LivingEntity)paramPlayer, 0.0F, PROJECTILE_SHOOT_POWER, 1.0F); }
/*    */     
...
/* 38 */     return (Projectile)new Snowball(paramLevel, paramPosition.x(), paramPosition.y(), paramPosition.z(), paramItemStack);
/*    */   }
/*    */ }
