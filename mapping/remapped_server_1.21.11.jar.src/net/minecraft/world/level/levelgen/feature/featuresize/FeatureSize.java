...
/* 17 */       .xmap(paramOptional -> (OptionalInt)paramOptional.map(OptionalInt::of).orElse(OptionalInt.empty()), paramOptionalInt -> paramOptionalInt.isPresent() ? Optional.<Integer>of(Integer.valueOf(paramOptionalInt.getAsInt())) : Optional.empty()).forGetter(paramFeatureSize -> paramFeatureSize.minClippedHeight);
/*    */   }
/*    */   
/*    */   protected final OptionalInt minClippedHeight;
/*    */   
/*    */   public FeatureSize(OptionalInt paramOptionalInt) {
/* 23 */     this.minClippedHeight = paramOptionalInt;
/*    */   }
/*    */ 
/*    */ 
/*    */ 
