...
/*     */   Boolean result;
/*     */   
/*     */   protected LazyCondition(SurfaceRules.Context paramContext) {
/* 232 */     this.context = paramContext;
/* 233 */     this.lastUpdate = getContextLastUpdate() - 1L;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean test() {
/* 238 */     long l = getContextLastUpdate();
/*     */     
/* 240 */     if (l == this.lastUpdate) {
