...
/*    */   static {
/* 11 */     CODEC = RecordCodecBuilder.mapCodec(paramInstance -> paramInstance.group((App)WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state").forGetter(WeatheringLightningRodBlock::getAge), (App)propertiesCodec()).apply((Applicative)paramInstance, WeatheringLightningRodBlock::new));
/*    */   }
/*    */   
...
/*    */ 
/*    */   
/*    */   protected WeatheringLightningRodBlock(WeatheringCopper.WeatherState paramWeatherState, BlockBehaviour.Properties paramProperties) {
