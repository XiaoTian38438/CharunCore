...
/*    */   
/*    */   public RandomLookAroundGoal(Mob paramMob) {
/* 14 */     this.mob = paramMob;
...
/*    */   
/*    */   public void start() {
/* 30 */     double d = 6.283185307179586D * this.mob.getRandom().nextDouble();
/* 31 */     this.relX = Math.cos(d);
/* 32 */     this.relZ = Math.sin(d);
