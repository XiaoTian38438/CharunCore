...
/*     */   
/*     */   public EndermanLeaveBlockGoal(EnderMan paramEnderMan) {
/* 535 */     this.enderman = paramEnderMan;
/*     */   }
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*     */   private boolean canPlaceBlock(Level paramLevel, BlockPos paramBlockPos1, BlockState paramBlockState1, BlockState paramBlockState2, BlockState paramBlockState3, BlockPos paramBlockPos2) {
/* 576 */     return (paramBlockState2.isAir() && !paramBlockState3.isAir() && !paramBlockState3.is(Blocks.BEDROCK) && paramBlockState3.isCollisionShapeFullBlock((BlockGetter)paramLevel, paramBlockPos2) && paramBlockState1.canSurvive((LevelReader)paramLevel, paramBlockPos1) && paramLevel
/* 577 */       .getEntities((Entity)this.enderman, AABB.unitCubeFromLowerCorner(Vec3.atLowerCornerOf((Vec3i)paramBlockPos1))).isEmpty());
/*     */   }
/*     */ }
