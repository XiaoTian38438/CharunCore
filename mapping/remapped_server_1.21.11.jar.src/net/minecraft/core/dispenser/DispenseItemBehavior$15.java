...
/* 456 */     PotionContents potionContents = (PotionContents)paramItemStack.getOrDefault(DataComponents.POTION_CONTENTS, PotionContents.EMPTY);
/* 457 */     if (!potionContents.is(Potions.WATER)) {
/* 458 */       return this.defaultDispenseItemBehavior.dispense(paramBlockSource, paramItemStack);
/*     */     }
/*     */     
/* 461 */     ServerLevel serverLevel = paramBlockSource.level();
/* 462 */     BlockPos blockPos1 = paramBlockSource.pos();
/*     */     
/* 464 */     BlockPos blockPos2 = paramBlockSource.pos().relative((Direction)paramBlockSource.state().getValue((Property)DispenserBlock.FACING));
...
/*     */       
/* 477 */       return consumeWithRemainder(paramBlockSource, paramItemStack, new ItemStack((ItemLike)Items.GLASS_BOTTLE));
/*     */     } 
/*     */     
/* 480 */     return this.defaultDispenseItemBehavior.dispense(paramBlockSource, paramItemStack);
/*     */   }
/*     */ }
