...
/* 287 */     ServerLevel serverLevel = paramBlockSource.level();
/* 288 */     if (!((Boolean)serverLevel.getGameRules().get(GameRules.TNT_EXPLODES)).booleanValue()) {
/* 289 */       setSuccess(false);
/* 290 */       return paramItemStack;
/*     */     } 
/*     */     
/* 293 */     BlockPos blockPos = paramBlockSource.pos().relative((Direction)paramBlockSource.state().getValue((Property)DispenserBlock.FACING));
/*     */     
...
/*     */     
/* 300 */     paramItemStack.shrink(1);
/* 301 */     setSuccess(true);
/* 302 */     return paramItemStack;
/*     */   }
/*     */ }
