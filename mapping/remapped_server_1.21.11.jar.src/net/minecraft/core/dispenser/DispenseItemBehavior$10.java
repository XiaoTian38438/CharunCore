...
/* 332 */     ServerLevel serverLevel = paramBlockSource.level();
/* 333 */     BlockPos blockPos = paramBlockSource.pos().relative((Direction)paramBlockSource.state().getValue((Property)DispenserBlock.FACING));
...
/*     */       } 
/* 341 */       paramItemStack.shrink(1);
/* 342 */       setSuccess(true);
/*     */     } else {
/* 344 */       setSuccess(EquipmentDispenseItemBehavior.dispenseEquipment(paramBlockSource, paramItemStack));
/*     */     } 
/* 346 */     return paramItemStack;
/*     */   }
/*     */ }
